...
## [25.5.3](https://github.com/esmevane/rivet/compare/v25.5.2...v25.5.3) (2026-05-30)


### Features

* **actors:** expose container system metrics ([#2664](https://github.com/esmevane/rivet/issues/2664)) ([c61646d](https://github.com/esmevane/rivet/commit/c61646d8657ce5e2775770d1b81cbf95b62480ff))
* add configurable minimum age for lost servers ([#2297](https://github.com/esmevane/rivet/issues/2297)) ([ccc3e41](https://github.com/esmevane/rivet/commit/ccc3e417e961e3800404ba7f753fd841f8ba52f7))
* add container platform comparison blog post ([#2639](https://github.com/esmevane/rivet/issues/2639)) ([9035ace](https://github.com/esmevane/rivet/commit/9035ace299c387573d4b5c8d1ecd177b03f14790))
* add driver context access in createVars function ([#2841](https://github.com/esmevane/rivet/issues/2841)) ([0309f87](https://github.com/esmevane/rivet/commit/0309f873471d8a0a8fc7e4d666f826a26da10c66))
* add frontend-hub service to docker-compose ([#2614](https://github.com/esmevane/rivet/issues/2614)) ([6c48e0f](https://github.com/esmevane/rivet/commit/6c48e0fc3f3a3c15cad11fb0515e184ab68c59a7))
* add in memory cache driver ([#2215](https://github.com/esmevane/rivet/issues/2215)) ([e5bc6e6](https://github.com/esmevane/rivet/commit/e5bc6e686335821c19d28cde67e79ea1afc7092a))
* add network to actor metdata ([#2245](https://github.com/esmevane/rivet/issues/2245)) ([b23a0ae](https://github.com/esmevane/rivet/commit/b23a0ae60a32efbbf7bcb66eba0ce3b1a9ad00ec))
* add non-interactive mode and route management options to CLI ([#2532](https://github.com/esmevane/rivet/issues/2532)) ([c729f94](https://github.com/esmevane/rivet/commit/c729f94efce02c80d664633e7a84c68b7f689554))
* add pb usage metrics, server state ([#2503](https://github.com/esmevane/rivet/issues/2503)) ([961149a](https://github.com/esmevane/rivet/commit/961149abe80432b94a21ef210c8ca33c4923e024))
* add retries to sql macros ([#2529](https://github.com/esmevane/rivet/issues/2529)) ([1f680de](https://github.com/esmevane/rivet/commit/1f680de444fc934b611f357cfcab8bbcff9e2a4a))
* add skip_upgrade flag for actor deployments ([#2739](https://github.com/esmevane/rivet/issues/2739)) ([f3e1051](https://github.com/esmevane/rivet/commit/f3e1051a41dc4ed21adec3b7e2ec05beb9c06d5d))
* **cli:** add --version flag to `deploy`, `build publish`, and `actor create` ([#2202](https://github.com/esmevane/rivet/issues/2202)) ([a0f0b66](https://github.com/esmevane/rivet/commit/a0f0b66b03d57e2ce4dc6bcf69b2b4298e73d8f0))
* **cli:** add `--env` to `rivet shell` command ([#2434](https://github.com/esmevane/rivet/issues/2434)) ([a0351bd](https://github.com/esmevane/rivet/commit/a0351bdccb9ed90245cd3f4972eb73f50878c212))
* **cli:** add `--extra-tags` and `--filter-tags` flags to `rivet deploy` ([#2224](https://github.com/esmevane/rivet/issues/2224)) ([12fbc1e](https://github.com/esmevane/rivet/commit/12fbc1e88959fffdc5227cb7b2ca9aec3caa78a6))
* **cli:** add `rivet kit endpoint` command ([#2653](https://github.com/esmevane/rivet/issues/2653)) ([5cdfcd2](https://github.com/esmevane/rivet/commit/5cdfcd209de5cb78bf4d003680db77216ec73f5a))
* **cli:** add `RIVET_ENDPOINT` and `RIVET_CLOUD_TOKEN` env vars for auth ([#2203](https://github.com/esmevane/rivet/issues/2203)) ([6ae4dc1](https://github.com/esmevane/rivet/commit/6ae4dc1a8fa7fe2551f6504971b5b54cddaf3dc3))
* **cli:** support passing env name to `rivet env select &lt;name&gt;` ([#2652](https://github.com/esmevane/rivet/issues/2652)) ([c04bdf7](https://github.com/esmevane/rivet/commit/c04bdf75e8d692fe848dbb3a787998da0468b963))
* **clusters:** add margin per pool ([#2543](https://github.com/esmevane/rivet/issues/2543)) ([dbe2a48](https://github.com/esmevane/rivet/commit/dbe2a485952f8de5ad9e63eb54c3aa95dc4de63f))
* compress sqlite db ([#2278](https://github.com/esmevane/rivet/issues/2278)) ([902bc29](https://github.com/esmevane/rivet/commit/902bc29417702397ffddd53eab49e578d0444b06))
* db sh for workflows ([#2570](https://github.com/esmevane/rivet/issues/2570)) ([b3ef5c8](https://github.com/esmevane/rivet/commit/b3ef5c85e5130fac2359293e88b28939483e09d6))
* edge nats ([#2220](https://github.com/esmevane/rivet/issues/2220)) ([adf646c](https://github.com/esmevane/rivet/commit/adf646cf6879a26718bc0f233a0d0a0a7898a72c))
* **examples:** multitenant using remote builds ([#2619](https://github.com/esmevane/rivet/issues/2619)) ([9b6888a](https://github.com/esmevane/rivet/commit/9b6888a8b5c55a47d4bcc13c017ccc9d0ae538a2))
* expose GET /actors/usage, GET /actors/logs, GET /actors/logs/export, GET /routes/history ([#2716](https://github.com/esmevane/rivet/issues/2716)) ([69144d3](https://github.com/esmevane/rivet/commit/69144d396852e80788209cc8e9830406c943c0ac))
* graceful worker shutdown ([#2274](https://github.com/esmevane/rivet/issues/2274)) ([ea92b9d](https://github.com/esmevane/rivet/commit/ea92b9dafcb391c7186aafbf550d4f499b60e92e))
* **guard:** add http ping endpoint to edge api hosts ([#2506](https://github.com/esmevane/rivet/issues/2506)) ([c33d254](https://github.com/esmevane/rivet/commit/c33d25498a90b85d0eb61c3788e3e13385970851))
* **guard:** support streaming responses ([#2667](https://github.com/esmevane/rivet/issues/2667)) ([90ab6ac](https://github.com/esmevane/rivet/commit/90ab6ac5e1a668a24cc3beb685bd63947273a4cc))
* **hub/studio:** remove empty docs ([#2339](https://github.com/esmevane/rivet/issues/2339)) ([ed95552](https://github.com/esmevane/rivet/commit/ed95552b55dc7c8d49c93633a76e446e26a6effe))
* **hub:** add a way to go direclty to an actor by id ([#2258](https://github.com/esmevane/rivet/issues/2258)) ([64e70ef](https://github.com/esmevane/rivet/commit/64e70ef5fefa375f79a2141c56523f135a5d9d99))
* **hub:** add actor-core inspector ([#2171](https://github.com/esmevane/rivet/issues/2171)) ([e6177fc](https://github.com/esmevane/rivet/commit/e6177fc1291cc28a9dc1b609c4b7551bc69e5b88))
* **hub:** add actors billing preview ([#2466](https://github.com/esmevane/rivet/issues/2466)) ([6728f28](https://github.com/esmevane/rivet/commit/6728f286aee921e8456853c68d4cdbf01be1a714))
* **hub:** add auth to inspector ([#2337](https://github.com/esmevane/rivet/issues/2337)) ([559218c](https://github.com/esmevane/rivet/commit/559218c2d9c6794015e379c8899a7ab3907d2a51))
* **hub:** add confirmation screen to feedback modal ([#2259](https://github.com/esmevane/rivet/issues/2259)) ([2a90622](https://github.com/esmevane/rivet/commit/2a90622c1e965bef40dc125fa8466d845d5189ec))
* **hub:** add loading indicator to actors and containers ([#2486](https://github.com/esmevane/rivet/issues/2486)) ([480e721](https://github.com/esmevane/rivet/commit/480e721009f0cadab87d9608251f2e5b9c7dc8be))
* **hub:** add metrics charts ([#2695](https://github.com/esmevane/rivet/issues/2695)) ([ab1f738](https://github.com/esmevane/rivet/commit/ab1f73877eae7eef3ebd4995b174c2af67ed8cf8))
* **hub:** add name column to actor builds ([#2172](https://github.com/esmevane/rivet/issues/2172)) ([e83ba5b](https://github.com/esmevane/rivet/commit/e83ba5bad78a022c750a9053064ce3fb47090df7))
* **hub:** bring hub to life ([#2234](https://github.com/esmevane/rivet/issues/2234)) ([90ff4a5](https://github.com/esmevane/rivet/commit/90ff4a54235e291c83cdfa296134c871fdfbaec2))
* **hub:** improve actor config readability ([#2261](https://github.com/esmevane/rivet/issues/2261)) ([582d933](https://github.com/esmevane/rivet/commit/582d9335dcab9b4d99dc94d31457018530002061))
* **hub:** improve get started guide ([#2496](https://github.com/esmevane/rivet/issues/2496)) ([509b929](https://github.com/esmevane/rivet/commit/509b929db4c81245708de8efd85500c6fd293819))
* **hub:** link to project after linking project ([#2037](https://github.com/esmevane/rivet/issues/2037)) ([3f8de12](https://github.com/esmevane/rivet/commit/3f8de12e31370f5980573671b6f7783f529c12e6))
* **hub:** logs ([#2364](https://github.com/esmevane/rivet/issues/2364)) ([cc22e91](https://github.com/esmevane/rivet/commit/cc22e919aec0cc859cdd32b34955bcccc5b7a31a))
* **hub:** truncate actor tags when in a table ([#2497](https://github.com/esmevane/rivet/issues/2497)) ([e349d6e](https://github.com/esmevane/rivet/commit/e349d6ed45fcdb91ba59f0a21ebd16ec30aa04a5))
* implement `clickhouse-user-query` ([#2554](https://github.com/esmevane/rivet/issues/2554)) ([4ceeadd](https://github.com/esmevane/rivet/commit/4ceeaddbf407bfa8aa95f30d714772606ff66e77))
* implement rivet guard ([#2276](https://github.com/esmevane/rivet/issues/2276)) ([9d61c63](https://github.com/esmevane/rivet/commit/9d61c63c42f861b15aaa2943b7c88c68abca3fc3))
* improve deploy summary with RivetKit endpoint ([#2655](https://github.com/esmevane/rivet/issues/2655)) ([32a93da](https://github.com/esmevane/rivet/commit/32a93daf10d5b20d4139eac109ff4b5a146bd09a))
* logs on clickhouse ([#2342](https://github.com/esmevane/rivet/issues/2342)) ([7cdd466](https://github.com/esmevane/rivet/commit/7cdd466db7d93b7b03ef5a6725f12d8c4dfa888d))
* **pegboard:** add draining state to alloc metrics ([#2565](https://github.com/esmevane/rivet/issues/2565)) ([befcf6d](https://github.com/esmevane/rivet/commit/befcf6d10fddff9576744e004615244eefdcb6bb))
* **pegboard:** add local image cache and overlay fs mounts ([#2586](https://github.com/esmevane/rivet/issues/2586)) ([da2b9e4](https://github.com/esmevane/rivet/commit/da2b9e47e48b9a32a7f047a59ce7ea43ac715d38))
* **pegboard:** add support for custom host entries ([#2627](https://github.com/esmevane/rivet/issues/2627)) ([898a9f8](https://github.com/esmevane/rivet/commit/898a9f8d6ba5410b04ac486fb74cd902eed37ce9))
* **pegboard:** expose rivet server from within containers for docker compose ([#2628](https://github.com/esmevane/rivet/issues/2628)) ([f872ff4](https://github.com/esmevane/rivet/commit/f872ff45b14b65256ef9b6815302e583b7dd453b))
* rg prod ([#2281](https://github.com/esmevane/rivet/issues/2281)) ([10aeaea](https://github.com/esmevane/rivet/commit/10aeaea348b34f0b2bf5815860da0decbd5f6e07))
* routes ([#2365](https://github.com/esmevane/rivet/issues/2365)) ([ee96ff9](https://github.com/esmevane/rivet/commit/ee96ff952679a1ab9ee433b8b589ee1ad64b0c81))
* **site:** add brand dropdown ([#2812](https://github.com/esmevane/rivet/issues/2812)) ([6e7a696](https://github.com/esmevane/rivet/commit/6e7a6961b5a3bf4228daec1822441199fba23939))
* **site:** add error pages ([#2604](https://github.com/esmevane/rivet/issues/2604)) ([aa4e63f](https://github.com/esmevane/rivet/commit/aa4e63f4c8cab0578ab186ada3e2208d5520d2e5))
* **site:** add giscus ([#2329](https://github.com/esmevane/rivet/issues/2329)) ([83f1f36](https://github.com/esmevane/rivet/commit/83f1f36fc375aff90adcf2bd782033a5114a8837))
* **site:** add newsleter ([#2803](https://github.com/esmevane/rivet/issues/2803)) ([88d29e6](https://github.com/esmevane/rivet/commit/88d29e6f3da15a786d49b23aada68ecad030dcce))
* **site:** add next.js docs ([#2834](https://github.com/esmevane/rivet/issues/2834)) ([7dff920](https://github.com/esmevane/rivet/commit/7dff92004fe893f00daf5fe597d4c16514deab6a))
* **site:** bring back docs navigation to mobile ([#2814](https://github.com/esmevane/rivet/issues/2814)) ([bbc72f8](https://github.com/esmevane/rivet/commit/bbc72f8b9e9325e88872074d5cbc0352c4e8d272))
* **site:** set user's email during newsletter form submission ([#2810](https://github.com/esmevane/rivet/issues/2810)) ([c235c8c](https://github.com/esmevane/rivet/commit/c235c8c439d19ec8bced4f00114788f244475bc9))
* **site:** upgrade to App Router and Nextjs 15.2 ([#2328](https://github.com/esmevane/rivet/issues/2328)) ([1a66c42](https://github.com/esmevane/rivet/commit/1a66c429b9d188cb12b29a68761f9ba586f69a88))
* **studio:** add actor-core studio ([#2283](https://github.com/esmevane/rivet/issues/2283)) ([7fd26d9](https://github.com/esmevane/rivet/commit/7fd26d90cefd03f3e97ecaf2685bc6d60b90311b))
* **studio:** reconnect with inspect ([#2333](https://github.com/esmevane/rivet/issues/2333)) ([28fda52](https://github.com/esmevane/rivet/commit/28fda52d6904216bd91ccbf31230445f87cbca73))
* **toolchain:** add rivetkit deployment support ([#2636](https://github.com/esmevane/rivet/issues/2636)) ([15f9a8e](https://github.com/esmevane/rivet/commit/15f9a8e2af8e981078287559fe6840c4d7db5641))
* **toolchain:** allow passing environment to functions ([#2624](https://github.com/esmevane/rivet/issues/2624)) ([e875d33](https://github.com/esmevane/rivet/commit/e875d3351b684d5d5863fc0815aa6a285c06e6bd))
* **toolchain:** build args support for remote builds ([#2583](https://github.com/esmevane/rivet/issues/2583)) ([5816b77](https://github.com/esmevane/rivet/commit/5816b77e1431230a5a5dd953db440cd940cb0ef4))
* **toolchain:** Implement dockerignore for remote builds ([#2590](https://github.com/esmevane/rivet/issues/2590)) ([34d4343](https://github.com/esmevane/rivet/commit/34d434375995821696a0afe7241a7ea5dad695b2))
* **toolchain:** remote build logs ([#2587](https://github.com/esmevane/rivet/issues/2587)) ([6579f85](https://github.com/esmevane/rivet/commit/6579f855eac7bc914441dd4c71bfbddf3c5ed6fd))
* **toolchain:** remote build method ([#2579](https://github.com/esmevane/rivet/issues/2579)) ([c9b525c](https://github.com/esmevane/rivet/commit/c9b525c051133119e23a3cb601db62bc48f141a8))
* **workflows:** sqlite WAL, deferrred flushing ([#2268](https://github.com/esmevane/rivet/issues/2268)) ([15cabdb](https://github.com/esmevane/rivet/commit/15cabdb3be35936c2cb4a4db42ae0164cfdcc39c))


### Bug Fixes

* 404 and descriptions ([#2830](https://github.com/esmevane/rivet/issues/2830)) ([ab281d6](https://github.com/esmevane/rivet/commit/ab281d6be5a3e38d98f0999bd9c5b33c0ef969a4))
* 404 redirects ([#2820](https://github.com/esmevane/rivet/issues/2820)) ([2a470a3](https://github.com/esmevane/rivet/commit/2a470a395a721694316ae9944478bc80a2e9967f))
* 404s ([#2835](https://github.com/esmevane/rivet/issues/2835)) ([239d76c](https://github.com/esmevane/rivet/commit/239d76c3392cafd841884c97f9b093c34dd430e7))
* add actor gen number, pb topo metric bug ([#2184](https://github.com/esmevane/rivet/issues/2184)) ([6410f61](https://github.com/esmevane/rivet/commit/6410f618258e394b46b882fd1baa536bf03fcf6b))
* add cache to server list queries ([#2620](https://github.com/esmevane/rivet/issues/2620)) ([e0fc4c6](https://github.com/esmevane/rivet/commit/e0fc4c6210871da4c3c3b72278fe51bd48419dd5))
* add create ts to server list ([#2523](https://github.com/esmevane/rivet/issues/2523)) ([8f39a94](https://github.com/esmevane/rivet/commit/8f39a94519e8537f174a8a824c54b0402e64b2b4))
* add future/fdb metrics ([#2377](https://github.com/esmevane/rivet/issues/2377)) ([37250d5](https://github.com/esmevane/rivet/commit/37250d5e3dc7897fdd31d8f21ef6597b07abb15b))
* add logs to ws ([#2412](https://github.com/esmevane/rivet/issues/2412)) ([0ab685a](https://github.com/esmevane/rivet/commit/0ab685ae5ebef7310f48f519a3789d6c708b8bd6))
* add max by to topo queries ([#2645](https://github.com/esmevane/rivet/issues/2645)) ([c0a9c3b](https://github.com/esmevane/rivet/commit/c0a9c3b83ddc3abf6040488264cf600189154fb2))
* add metrics to ops and guard ([#2429](https://github.com/esmevane/rivet/issues/2429)) ([9cd808a](https://github.com/esmevane/rivet/commit/9cd808aed6ef45a0250d2c3b167c9965e035b755))
* add otel collector tail sampler ([#2411](https://github.com/esmevane/rivet/issues/2411)) ([026e21b](https://github.com/esmevane/rivet/commit/026e21b74bbc50dddc6014a658fe00a1a755be09))
* add prepare script to @rivet-gg/cli so it builds before postinstall ([1020e3a](https://github.com/esmevane/rivet/commit/1020e3aff9cb6b752b7854289d263e6bb2e5ba8c))
* Add redirects for 404 documentation URLs ([#2816](https://github.com/esmevane/rivet/issues/2816)) ([3ada1b2](https://github.com/esmevane/rivet/commit/3ada1b2ac330b8f9a6da69c8a3a4783b7298d109))
* add silencing to fdb driver ([#2177](https://github.com/esmevane/rivet/issues/2177)) ([5a21426](https://github.com/esmevane/rivet/commit/5a2142683939fd195a4c53420d904ee909cc76e7))
* add trace info to wfs and actor api ([#2341](https://github.com/esmevane/rivet/issues/2341)) ([7accb37](https://github.com/esmevane/rivet/commit/7accb37bc5e232e3bba0e8813f1e7e7f4f01d8e0))
* add udp test to system test ([#2417](https://github.com/esmevane/rivet/issues/2417)) ([91d820a](https://github.com/esmevane/rivet/commit/91d820a30cc87a9de90989f2c2a75a28f821167e))
* add vector http config to edge configs ([#2553](https://github.com/esmevane/rivet/issues/2553)) ([e54fd50](https://github.com/esmevane/rivet/commit/e54fd50795e61b41d3aac522d83f3e2ce4a43fdb))
* additional 404 redirects ([#2818](https://github.com/esmevane/rivet/issues/2818)) ([d0f94ca](https://github.com/esmevane/rivet/commit/d0f94cacbfd6748507cb7d8cb5a9978ad2c06397))
* allow custom project for status monitor ([#2415](https://github.com/esmevane/rivet/issues/2415)) ([9f6a5a7](https://github.com/esmevane/rivet/commit/9f6a5a7950f07d1110bb36fc584d539c5133446b))
* **api-actor:** fix actor list showing wrong order ([#2228](https://github.com/esmevane/rivet/issues/2228)) ([3dec92c](https://github.com/esmevane/rivet/commit/3dec92c898932d5f65dd97d31a3e1f8f13720996))
* **api:** handle wrapped operation errors ([#2602](https://github.com/esmevane/rivet/issues/2602)) ([d8ea7be](https://github.com/esmevane/rivet/commit/d8ea7be79e9df4089f1c4afc1f2813a01f71fb70))
* auto-create routes for RivetKit in non-interactive mode ([#2654](https://github.com/esmevane/rivet/issues/2654)) ([39fcfd9](https://github.com/esmevane/rivet/commit/39fcfd9c27b8172155b457171de2d3158ce124f3))
* **blog:** update cloudflare docs links ([#2641](https://github.com/esmevane/rivet/issues/2641)) ([9488a70](https://github.com/esmevane/rivet/commit/9488a70006ce10443e8c247889f05fff9ddd5406))
* **cache:** add traces ([#2489](https://github.com/esmevane/rivet/issues/2489)) ([b316d41](https://github.com/esmevane/rivet/commit/b316d41f2b3ae876e499273ba3c3aecdca27456b))
* canonical URLs ([#2822](https://github.com/esmevane/rivet/issues/2822)) ([b9d6013](https://github.com/esmevane/rivet/commit/b9d6013b275240e9a77eaecd2c2268514586ed60))
* change invalid atom value ([#2600](https://github.com/esmevane/rivet/issues/2600)) ([117f5dd](https://github.com/esmevane/rivet/commit/117f5dddd908d9c8faa63185bdce52831bf5ed7d))
* **cli:** adjust @rivet-gg/cli for npm ([#2174](https://github.com/esmevane/rivet/issues/2174)) ([3d49081](https://github.com/esmevane/rivet/commit/3d49081974004f9744df8f947ea62741a34436fd))
* **cli:** fix cli compiled without transport feature ([#2403](https://github.com/esmevane/rivet/issues/2403)) ([a46b2f5](https://github.com/esmevane/rivet/commit/a46b2f586e1b7b55fa7da4d55fe3e2fb1a19388f))
* **cli:** internal_port u8 -&gt; u16 ([#2424](https://github.com/esmevane/rivet/issues/2424)) ([6d024f5](https://github.com/esmevane/rivet/commit/6d024f5066e0293554a221e1f72fd01e7aa7b1e6))
* **cli:** remove openssl dependency again ([#2393](https://github.com/esmevane/rivet/issues/2393)) ([aed5eef](https://github.com/esmevane/rivet/commit/aed5eef6e9f193861974f5b32e39b95e58d0af11))
* **cluster:** dc workflow does not insert row on creation ([#2610](https://github.com/esmevane/rivet/issues/2610)) ([91fd539](https://github.com/esmevane/rivet/commit/91fd53934d8bee38cf9c9d1bd3db2f06d7dd4693))
* **cluster:** fix nats provisioned in wrong subnet ([#2296](https://github.com/esmevane/rivet/issues/2296)) ([ec4edcd](https://github.com/esmevane/rivet/commit/ec4edcdf27688aeadaac5e39133d5c9056543c7c))
* **cluster:** fix pbi autoscaling ([#2592](https://github.com/esmevane/rivet/issues/2592)) ([8bc423f](https://github.com/esmevane/rivet/commit/8bc423f9ed381b8ca809a67bbe55ea1ad4b0b3af))
* **cluster:** fix scaling logic and dedup metrics ([#2566](https://github.com/esmevane/rivet/issues/2566)) ([d632ace](https://github.com/esmevane/rivet/commit/d632ace04294b1fcdeba8316cdac96891a504f60))
* **container-runner:** fix leaked pipes ([#2473](https://github.com/esmevane/rivet/issues/2473)) ([121a4a4](https://github.com/esmevane/rivet/commit/121a4a4953e7978902417579a437b9e0bc22c157))
* core features alignment ([#2186](https://github.com/esmevane/rivet/issues/2186)) ([34b52da](https://github.com/esmevane/rivet/commit/34b52da94a85274a150b53a05128497e0d700f18))
* correct memory safety vs correctness guarantees in blog post ([#2534](https://github.com/esmevane/rivet/issues/2534)) ([4f0663b](https://github.com/esmevane/rivet/commit/4f0663baceffd1c757100192f48716bc816016c8))
* **dev-full:** update to use new ports ([#2717](https://github.com/esmevane/rivet/issues/2717)) ([74e2654](https://github.com/esmevane/rivet/commit/74e26546228d2c1d35b615228a43301b210909cb))
* disambiguate cluster_id &lt;-&gt; instance_id ([#2472](https://github.com/esmevane/rivet/issues/2472)) ([6fccebb](https://github.com/esmevane/rivet/commit/6fccebb9b140d666af84eb088b4f5a14e4bf304c))
* dont include installing servers in service discovery ([#2569](https://github.com/esmevane/rivet/issues/2569)) ([95da029](https://github.com/esmevane/rivet/commit/95da029b112219957267b30c4515fe4972510142))
* fallback if @rivet-gg/cli doesn't work ([0897635](https://github.com/esmevane/rivet/commit/0897635965e5672c2084d94cebef0da720ec9873))
* fix build cache key ([#2530](https://github.com/esmevane/rivet/issues/2530)) ([3c7f0b3](https://github.com/esmevane/rivet/commit/3c7f0b388870df80117808d36b37d75df4d8ce91))
* fix building api packages ([7735744](https://github.com/esmevane/rivet/commit/77357446e715dea13e707f273b5972f65e9988f1))
* fix client leaked pipes ([#2474](https://github.com/esmevane/rivet/issues/2474)) ([39220d3](https://github.com/esmevane/rivet/commit/39220d35a182aa99f401646169a61e96d8d89293))
* fix copy pasta typo in route propegation rip ([#2536](https://github.com/esmevane/rivet/issues/2536)) ([639afa9](https://github.com/esmevane/rivet/commit/639afa977761b38efbac9e836da788069f452610))
* fix edge dc eligible calculation ([#2567](https://github.com/esmevane/rivet/issues/2567)) ([72c45a0](https://github.com/esmevane/rivet/commit/72c45a03185bacec658d13209322a9d2f092a43a))
* fix fdb cli, wf pulling ([#2418](https://github.com/esmevane/rivet/issues/2418)) ([a8d5b7a](https://github.com/esmevane/rivet/commit/a8d5b7a1747245c9ecd5cbe46d0680a7095b3e17))
* fix metrics ([#2416](https://github.com/esmevane/rivet/issues/2416)) ([b2f092d](https://github.com/esmevane/rivet/commit/b2f092d96dc385cebb77c4e585f6764ca3ad96fc))
* fix npm package naming ([#2679](https://github.com/esmevane/rivet/issues/2679)) ([6c6bcb2](https://github.com/esmevane/rivet/commit/6c6bcb238f3d5a83c2635540cb338af5a71124a1))
* fix pb metrics standalone ([#2518](https://github.com/esmevane/rivet/issues/2518)) ([eeb9b08](https://github.com/esmevane/rivet/commit/eeb9b08ab5c587dd4d480162396e573a4208a71e))
* fix ports ([#2729](https://github.com/esmevane/rivet/issues/2729)) ([e13ac80](https://github.com/esmevane/rivet/commit/e13ac80c95022dfa4f797a24cf2c52f35b3beb11))
* fix release script to use endpoint url flag instead of env var for aws ([#2685](https://github.com/esmevane/rivet/issues/2685)) ([0c3e948](https://github.com/esmevane/rivet/commit/0c3e9485f09025285352c20ccd5f314103d17cf3))
* fix release update versions ([f10bfca](https://github.com/esmevane/rivet/commit/f10bfcaece4e6163581d28c8a5bf5437ca64a450))
* gracefully handle prom failure for pb topo ([#2731](https://github.com/esmevane/rivet/issues/2731)) ([2840095](https://github.com/esmevane/rivet/commit/28400957ef3370d9a85001b36bf22801fb69854e))
* **guard:** add cache clearing to ws retry, increase ws retries ([#2448](https://github.com/esmevane/rivet/issues/2448)) ([65aa627](https://github.com/esmevane/rivet/commit/65aa627a5b62205e8d97bcc6a2acc3c042c466f0))
* **guard:** add dedicated websocket proxy handler ([#2321](https://github.com/esmevane/rivet/issues/2321)) ([bd718cf](https://github.com/esmevane/rivet/commit/bd718cf3a424227d5927bf4e3354cfb7633aee4f))
* **guard:** add metrics ([#2480](https://github.com/esmevane/rivet/issues/2480)) ([3cee110](https://github.com/esmevane/rivet/commit/3cee11016f4dabd74651e294952dafd270add2bc))
* **guard:** add more tokio runtime metrics, remove labels from metrics ([#2485](https://github.com/esmevane/rivet/issues/2485)) ([5b84ccc](https://github.com/esmevane/rivet/commit/5b84ccc942d01ef77867e26d2036f145ca564b49))
* **guard:** allow routing to path-based endpoints via any hostname for dev clusters ([#2469](https://github.com/esmevane/rivet/issues/2469)) ([ba7a88d](https://github.com/esmevane/rivet/commit/ba7a88dc3f4afac48d9addeae3c7726e894a4ee9))
* **guard:** dont route to installing api nodes ([#2564](https://github.com/esmevane/rivet/issues/2564)) ([86c6e41](https://github.com/esmevane/rivet/commit/86c6e41d1fb3458ec58513349fa66c0ec2563302))
* **guard:** fix websocket proxying ([#2314](https://github.com/esmevane/rivet/issues/2314)) ([cbeeb86](https://github.com/esmevane/rivet/commit/cbeeb86a0c2f7868d0cfb95edfbf6017f8fc1dba))
* **guard:** purge cache on connect error ([#2344](https://github.com/esmevane/rivet/issues/2344)) ([9cbd422](https://github.com/esmevane/rivet/commit/9cbd42265695d2721fb496e8cf45dac8c340fda5))
* **guard:** replace internal caches with moka ([#2481](https://github.com/esmevane/rivet/issues/2481)) ([c88362c](https://github.com/esmevane/rivet/commit/c88362c16c318bde3c905a4d03fb7270b505ccfd))
* **guard:** return error response on router error ([#2540](https://github.com/esmevane/rivet/issues/2540)) ([cad72fe](https://github.com/esmevane/rivet/commit/cad72fe7f7424a59aaef544eb57cd4311130c17a))
* hide functions in containers view ([#2594](https://github.com/esmevane/rivet/issues/2594)) ([258dd58](https://github.com/esmevane/rivet/commit/258dd583b42f4d134de3ef8863f85d155cff92a6))
* hide functions in containers view ([#2597](https://github.com/esmevane/rivet/issues/2597)) ([097b545](https://github.com/esmevane/rivet/commit/097b5451e33a60fc871ce3d782acfbec7103d5f2))
* **hub:** add missing dalas icon ([#2838](https://github.com/esmevane/rivet/issues/2838)) ([b78c3d6](https://github.com/esmevane/rivet/commit/b78c3d673674f6a25139bd76ed482ebcd18e736a))
* **hub:** add trailing slashes to urls when missing ([#2179](https://github.com/esmevane/rivet/issues/2179)) ([3cbbbfe](https://github.com/esmevane/rivet/commit/3cbbbfef02433b87dde0ef61ab04876d7d16cfbb))
* **hub:** bring back monospace font ([#2781](https://github.com/esmevane/rivet/issues/2781)) ([865550c](https://github.com/esmevane/rivet/commit/865550cf6264e22b591781ea087368c07d713f5f))
* **hub:** cancelled error are now properly handled ([#2254](https://github.com/esmevane/rivet/issues/2254)) ([7aa18a2](https://github.com/esmevane/rivet/commit/7aa18a23567bd979067221da6b3ee7c89a9901d2))
* **hub:** close modal after creating a team ([#2498](https://github.com/esmevane/rivet/issues/2498)) ([85a5c84](https://github.com/esmevane/rivet/commit/85a5c84d2702b56ec8ed4ecdef2a383c325ed7bc))
* **hub:** containers screen overflow issues ([#2545](https://github.com/esmevane/rivet/issues/2545)) ([5ba15dd](https://github.com/esmevane/rivet/commit/5ba15dd483fcae4d826f8b1d57e58effdb9e474b))
* **hub:** display fold buttons when actor is not selected ([#2262](https://github.com/esmevane/rivet/issues/2262)) ([5de99e8](https://github.com/esmevane/rivet/commit/5de99e8410b38f78db7df6d65e9bd01f7cc939b4))
* **hub:** do not force users to go through onboarding when they already have projects created ([#2499](https://github.com/esmevane/rivet/issues/2499)) ([1135677](https://github.com/esmevane/rivet/commit/1135677382e34690722ec15abdf334b994983e28))
* **hub:** fix login loop ([#2239](https://github.com/esmevane/rivet/issues/2239)) ([fe6587f](https://github.com/esmevane/rivet/commit/fe6587ffb5e8a0c3f5bc005dd4c06ee2160ffbd5))
* **hub:** generate stripe sessions links aot ([#2494](https://github.com/esmevane/rivet/issues/2494)) ([e3f8c7f](https://github.com/esmevane/rivet/commit/e3f8c7f4d1fa13bb8b716e9287501afa964b0e35))
* **hub:** getting started introduction ([#2169](https://github.com/esmevane/rivet/issues/2169)) ([42a49c6](https://github.com/esmevane/rivet/commit/42a49c6560c3ccccdf3b34226c4a4150ee74b8cb))
* **hub:** group name validation ([#2256](https://github.com/esmevane/rivet/issues/2256)) ([69120dd](https://github.com/esmevane/rivet/commit/69120ddd9ffd970f858c7579709ef7d239b036ea))
* **hub:** invalidate billing calculation after chagning the billing plan ([#2547](https://github.com/esmevane/rivet/issues/2547)) ([c3a8a1e](https://github.com/esmevane/rivet/commit/c3a8a1eba531bcd9c4d550a0f3eef9765ad073fa))
* **hub:** login issues ([#2241](https://github.com/esmevane/rivet/issues/2241)) ([4dec3ef](https://github.com/esmevane/rivet/commit/4dec3efc3d1e535d0835dfb2a30bf6b4adbe3c6f))
* **hub:** make sure kill timeout is properly displayed ([#2488](https://github.com/esmevane/rivet/issues/2488)) ([d8b1a65](https://github.com/esmevane/rivet/commit/d8b1a650a25ea9ea6d65165761b21a9708746e6b))
* **hub:** minor fixes to filters and sidebar ([#2439](https://github.com/esmevane/rivet/issues/2439)) ([a2aeafd](https://github.com/esmevane/rivet/commit/a2aeafd1ec75836cc386d35bc27bf7c8da2908e1))
* **hub:** minor polishing ([#2444](https://github.com/esmevane/rivet/issues/2444)) ([b2e5f8f](https://github.com/esmevane/rivet/commit/b2e5f8fe65a2575f7322cb801d26543f3c1e4a7e))
* **hub:** missing message in logs txt file ([#2555](https://github.com/esmevane/rivet/issues/2555)) ([f26f599](https://github.com/esmevane/rivet/commit/f26f599b0bd17d8c9e4f909958917adc0396ef33))
* **hub:** missing message in logs txt file ([#2557](https://github.com/esmevane/rivet/issues/2557)) ([34d6973](https://github.com/esmevane/rivet/commit/34d697306b8a9ab0180e9f2553a0a8a56c779ef2))
* **hub:** re-render breadcrumbs on route change ([#2260](https://github.com/esmevane/rivet/issues/2260)) ([be207d7](https://github.com/esmevane/rivet/commit/be207d7242355e43ed1362d0ca731a63de341fab))
* **hub:** refactor validation for functions ([#2647](https://github.com/esmevane/rivet/issues/2647)) ([bc97b4a](https://github.com/esmevane/rivet/commit/bc97b4aeab9ba626a1f019655f9665633f2c5801))
* **hub:** remove trash icon from actor logs ([#2257](https://github.com/esmevane/rivet/issues/2257)) ([30e2a48](https://github.com/esmevane/rivet/commit/30e2a48397ed379dc242dc1015e85ab5712538c2))
* **hub:** two cmd+k pannels is too much ([#2491](https://github.com/esmevane/rivet/issues/2491)) ([dc35946](https://github.com/esmevane/rivet/commit/dc35946be370e360a79fda5edad05510706c899f))
* **hub:** use proper logo in footer ([#2495](https://github.com/esmevane/rivet/issues/2495)) ([be885f6](https://github.com/esmevane/rivet/commit/be885f69680eac431f5e08743b44008ff83612a0))
* improve error handling in status check ([#2563](https://github.com/esmevane/rivet/issues/2563)) ([6b786d0](https://github.com/esmevane/rivet/commit/6b786d0bf04c55518ea24974633106a302acdf32))
* increase log limits ([#2646](https://github.com/esmevane/rivet/issues/2646)) ([fa3f299](https://github.com/esmevane/rivet/commit/fa3f299689f305389b4b9f7e80c8267b70515099))
* links and orphan pages ([#2824](https://github.com/esmevane/rivet/issues/2824)) ([d25aced](https://github.com/esmevane/rivet/commit/d25aced8351802d0e2ef9158c4ae4efb3b6576ac))
* load aurrent actor if its outside of current pagination window ([#2772](https://github.com/esmevane/rivet/issues/2772)) ([23c76be](https://github.com/esmevane/rivet/commit/23c76be85f3587c4e6eda9c9b147f349fc7d9481))
* make artifact size changes not break wf ([#2726](https://github.com/esmevane/rivet/issues/2726)) ([17620f8](https://github.com/esmevane/rivet/commit/17620f80b8670c2487a60d6317830aa33c13295b))
* make copy buttons copy again ([#2379](https://github.com/esmevane/rivet/issues/2379)) ([d9e6701](https://github.com/esmevane/rivet/commit/d9e6701af5055f9a1888428e6ae405ed654826d9))
* make service discovery use a single client ([#2621](https://github.com/esmevane/rivet/issues/2621)) ([5a8daa4](https://github.com/esmevane/rivet/commit/5a8daa4da9374f5d0462f2627a84802dfae84c52))
* missing existence check ([#2599](https://github.com/esmevane/rivet/issues/2599)) ([ce4e2b0](https://github.com/esmevane/rivet/commit/ce4e2b0fd4f6bf699b95de67ec9f36869caca9e0))
* **pb:** fix actor reschedule with wrong image ([#2428](https://github.com/esmevane/rivet/issues/2428)) ([ad8ea6b](https://github.com/esmevane/rivet/commit/ad8ea6b9fba62a534a2e6905f57165072e7f990d))
* **pegboard:** configure crypto for isolate-v8-runner ([#2310](https://github.com/esmevane/rivet/issues/2310)) ([c164e55](https://github.com/esmevane/rivet/commit/c164e558a44a3776123de69e73e32b2b882e1d90))
* **pegboard:** continue exporting metrics even if fetching actor fails ([#2520](https://github.com/esmevane/rivet/issues/2520)) ([9ca20cf](https://github.com/esmevane/rivet/commit/9ca20cf8f2b2167cdfcbf500d9d09e4a16089c6c))
* **pegboard:** fix allocation metrics ([#2568](https://github.com/esmevane/rivet/issues/2568)) ([9b454d7](https://github.com/esmevane/rivet/commit/9b454d738c7257f9f1bc05a6db24352edb3def3e))
* **pegboard:** fix collecting metrics for actors without workflows ([#2519](https://github.com/esmevane/rivet/issues/2519)) ([9af8aa1](https://github.com/esmevane/rivet/commit/9af8aa149e9af3796b065429bb1f7730ff5db4f8))
* **pegboard:** fix container runner orphaning ([#2575](https://github.com/esmevane/rivet/issues/2575)) ([88ec694](https://github.com/esmevane/rivet/commit/88ec69445a733c80c01c548043993dedf97a12f2))
* **pegboard:** fix enabling root users ([#2572](https://github.com/esmevane/rivet/issues/2572)) ([edfe98f](https://github.com/esmevane/rivet/commit/edfe98f7f35e5c5c6eea4a6d43542d7f28bc7230))
* **pegboard:** fix hosts file not getting written correctly ([#2626](https://github.com/esmevane/rivet/issues/2626)) ([1a51658](https://github.com/esmevane/rivet/commit/1a5165809fb753dc5dab8736bbfb65868eb002cf))
* **pegboard:** fix manager tests ([#2286](https://github.com/esmevane/rivet/issues/2286)) ([30e02e9](https://github.com/esmevane/rivet/commit/30e02e9528b0156fb65db66dd7075fa0c12b9494))
* **pegboard:** fix netns path bug ([#2431](https://github.com/esmevane/rivet/issues/2431)) ([36252ec](https://github.com/esmevane/rivet/commit/36252ec8694939c3b50cdcbc96c9379816f89484))
* **pegboard:** fix prewarm logic ([#2409](https://github.com/esmevane/rivet/issues/2409)) ([abdda32](https://github.com/esmevane/rivet/commit/abdda32dce8bf514cc98f076ccd266441d2a60a3))
* **pegboard:** ignore all packets before init ([#2363](https://github.com/esmevane/rivet/issues/2363)) ([280bf12](https://github.com/esmevane/rivet/commit/280bf1280dce06516ec4a9f703b499329ea549a6))
* **pegboard:** include namespace in actor log query ([#2712](https://github.com/esmevane/rivet/issues/2712)) ([5cc7d50](https://github.com/esmevane/rivet/commit/5cc7d506e002c8433d7157e25b972f7e99b44c98))
* **pegboard:** increase actor log ttl to 14 days ([#2544](https://github.com/esmevane/rivet/issues/2544)) ([925250a](https://github.com/esmevane/rivet/commit/925250a337ea37bf9da91547df4fb36ad09aa7ca))
* **pegboard:** increase signal timeout, add check for actor exit ([#2538](https://github.com/esmevane/rivet/issues/2538)) ([32b516a](https://github.com/esmevane/rivet/commit/32b516aa0cac6e1f8ecf59960e6e493b612cd0c2))
* **pegboard:** revise actor rescheduling algorithm, add client metrics ([#2531](https://github.com/esmevane/rivet/issues/2531)) ([e3b6c06](https://github.com/esmevane/rivet/commit/e3b6c0650f90aba981c95dec1613f69f82bb2c81))
* **pegboard:** wait for actor allocation not creation ([#2539](https://github.com/esmevane/rivet/issues/2539)) ([6fb6e53](https://github.com/esmevane/rivet/commit/6fb6e5304d8edfa15d7743dbf6bfde4588f0551c))
* reduce cardinality of metrics ([#2691](https://github.com/esmevane/rivet/issues/2691)) ([e63f5c1](https://github.com/esmevane/rivet/commit/e63f5c1744b6304a7cab1952f57b2e44bb79b28d))
* **release:** fix generate api path ([c9926da](https://github.com/esmevane/rivet/commit/c9926da7f8901ca35b84208dbbfa6e4228d5ade7))
* **release:** fix replace install script version ([7e69fc0](https://github.com/esmevane/rivet/commit/7e69fc0026f4edb6d0e0e12add903b8784785bb2))
* remove iptables filter after CNI ([#2421](https://github.com/esmevane/rivet/issues/2421)) ([631965b](https://github.com/esmevane/rivet/commit/631965b1b219e6224c0bf616caeb94bc81492398))
* remove landing animation ([#2189](https://github.com/esmevane/rivet/issues/2189)) ([51946bb](https://github.com/esmevane/rivet/commit/51946bbcc419e7eda53f2465a4f14e4e2c1fb508))
* remove node_modules hack in favor of yarn pnp ([816046e](https://github.com/esmevane/rivet/commit/816046ebb1388cf86f3b7ea2ecb725bb32d7ac42))
* remove nonexistent actor sdk from release script ([598adc7](https://github.com/esmevane/rivet/commit/598adc76ba398cd9eddd7dfab9b8280834485d5b))
* reset actor gc before reschedule ([#2175](https://github.com/esmevane/rivet/issues/2175)) ([83d4598](https://github.com/esmevane/rivet/commit/83d4598a217871b59078f2c140b0843708b26803))
* return after actor create ([#2347](https://github.com/esmevane/rivet/issues/2347)) ([d6fbf36](https://github.com/esmevane/rivet/commit/d6fbf362709583b31fe2925b60c3bf7e311c34b6))
* **sdks/api:** fix ignores ignoring types dir ([84ae1c1](https://github.com/esmevane/rivet/commit/84ae1c1c4aef0f1df57ba0c29d63530523e300d8))
* SEO improvements ([#2827](https://github.com/esmevane/rivet/issues/2827)) ([32ac342](https://github.com/esmevane/rivet/commit/32ac342f6e6c41155ef815bfd78562a1b41ddde6))
* **site:** broken sales / missing support page ([#2559](https://github.com/esmevane/rivet/issues/2559)) ([db6b40b](https://github.com/esmevane/rivet/commit/db6b40b652573b4c471fa4d790c35586a6ffcb05))
* **site:** broken sales / missing support page ([#2561](https://github.com/esmevane/rivet/issues/2561)) ([3b81ca3](https://github.com/esmevane/rivet/commit/3b81ca3a51341fef691e90b0d5218eb380e43f2a))
* **site:** deployment ([#2331](https://github.com/esmevane/rivet/issues/2331)) ([8e95ac6](https://github.com/esmevane/rivet/commit/8e95ac6f368aaa43e0beb01af37c5a3b4278dea4))
* **site:** display of code blocks ([#2323](https://github.com/esmevane/rivet/issues/2323)) ([0b9d562](https://github.com/esmevane/rivet/commit/0b9d56266040d654c3ff49775f68e2e7250a573f))
* **site:** fix generate api path ([73a05a5](https://github.com/esmevane/rivet/commit/73a05a5c76bb730b3e9a7d7220ca70042d095d4d))
* **site:** fix initial animation state in sidebar ([#2797](https://github.com/esmevane/rivet/issues/2797)) ([4221722](https://github.com/esmevane/rivet/commit/42217221fc25b2180493fc3bfdbbebae8dd9480a))
* **site:** fix llms.txt link ([#2787](https://github.com/esmevane/rivet/issues/2787)) ([bc24ee5](https://github.com/esmevane/rivet/commit/bc24ee58ceaeb87eb66bf29bd1ee5076d456f12c))
* **site:** invalid actors import leaking to site ([#2330](https://github.com/esmevane/rivet/issues/2330)) ([c57a557](https://github.com/esmevane/rivet/commit/c57a5579aeab7e2e51d11076e849abc6ecacb92c))
* sqlite driver tweaks ([#2370](https://github.com/esmevane/rivet/issues/2370)) ([701e77b](https://github.com/esmevane/rivet/commit/701e77bc9fbf626b6a7b4c0bf42b13298dee11e6))
* sqlite lock error ([#2672](https://github.com/esmevane/rivet/issues/2672)) ([e187b64](https://github.com/esmevane/rivet/commit/e187b64847f93eb79880a476da42861bc6ed06b8))
* **studio:** change layout and make console autoscroll ([#2334](https://github.com/esmevane/rivet/issues/2334)) ([cb8bc18](https://github.com/esmevane/rivet/commit/cb8bc18778b76f66aa77d476a682f55d1c886f2e))
* **studio:** items flows incorreclty on getting started screen ([#2542](https://github.com/esmevane/rivet/issues/2542)) ([d6bc547](https://github.com/esmevane/rivet/commit/d6bc54706d4549ea51e9079c0a04783c1aaee25a))
* **studio:** minor studio fixes ([#2306](https://github.com/esmevane/rivet/issues/2306)) ([a5f41c5](https://github.com/esmevane/rivet/commit/a5f41c543c66d1597e94eda75ec374155beae6dc))
* swap status monitor dns resolver with native resolver ([#2432](https://github.com/esmevane/rivet/issues/2432)) ([d450f12](https://github.com/esmevane/rivet/commit/d450f1256077bd0528e950b9551d8c5919f5771d))
* **toolchain:** attach tags to function workers ([#2617](https://github.com/esmevane/rivet/issues/2617)) ([334e2c6](https://github.com/esmevane/rivet/commit/334e2c6d7aa4ae5ba8e38988b77d989c9b06d08a))
* **toolchain:** creating ci env no longer fails first try ([#2618](https://github.com/esmevane/rivet/issues/2618)) ([da726ec](https://github.com/esmevane/rivet/commit/da726ec51c123ecf9c36adaa7f264edcc819d04e))
* **toolchain:** dont upgrade for deploys by default ([#2743](https://github.com/esmevane/rivet/issues/2743)) ([135d982](https://github.com/esmevane/rivet/commit/135d982fc60c81cd5b231bde96b2d09247636977))
* **toolchain:** fix compat with deploying using podman ([#2571](https://github.com/esmevane/rivet/issues/2571)) ([716868c](https://github.com/esmevane/rivet/commit/716868c4c3d6ed4e3fc9e68f1ddd29234bb72c73))
* **toolchain:** fix creating route failing silently ([#2601](https://github.com/esmevane/rivet/issues/2601)) ([7f9bf14](https://github.com/esmevane/rivet/commit/7f9bf141811b5f737d7f33280ee557106708c63c))
* **toolchain:** fix fallback package manager to npm ([#2650](https://github.com/esmevane/rivet/issues/2650)) ([a256a69](https://github.com/esmevane/rivet/commit/a256a6901ea92a2187a68d1abb82a2c2f751c997))
* **toolchain:** fix symlinks &gt; 100 chars not being archived correctly ([#2651](https://github.com/esmevane/rivet/issues/2651)) ([8e37d4c](https://github.com/esmevane/rivet/commit/8e37d4cb4de2044032acb9ba80f0806f1fd65526))
* **toolchain:** mark external deps ([#2713](https://github.com/esmevane/rivet/issues/2713)) ([4ca8675](https://github.com/esmevane/rivet/commit/4ca8675a3aa10a9709a3ed7c7c2768f70007dbb3))
* uncomment function type filter in ACTORS_FILTER ([#2533](https://github.com/esmevane/rivet/issues/2533)) ([f7d97c9](https://github.com/esmevane/rivet/commit/f7d97c9715c16a8a404e9cde8d9e04a401b907ef))
* update @rivet-gg/components path in tailwind config ([#2613](https://github.com/esmevane/rivet/issues/2613)) ([4033c74](https://github.com/esmevane/rivet/commit/4033c74fd487f8b1d6671120ee66acb2c3d70587))
* update Claude URL from /chat to /new ([#2790](https://github.com/esmevane/rivet/issues/2790)) ([24e4666](https://github.com/esmevane/rivet/commit/24e46666c1f66a2c029f8d6cda48b81e52b8638f))
* update cli image and wording ([#2193](https://github.com/esmevane/rivet/issues/2193)) ([a3ca882](https://github.com/esmevane/rivet/commit/a3ca8826dfcafdacf187fb0b0aeb0f39edbb3946))
* update PowerShell version pattern in install docs ([#2703](https://github.com/esmevane/rivet/issues/2703)) ([93e3d68](https://github.com/esmevane/rivet/commit/93e3d68792e99ff992b5019cbb101e70555af583))
* update runtime api to fern v0.49 ([#2391](https://github.com/esmevane/rivet/issues/2391)) ([26f9683](https://github.com/esmevane/rivet/commit/26f96831d0453a66d025fe59c4607dc4d763ac93))
* update version references in install documentation ([#2708](https://github.com/esmevane/rivet/issues/2708)) ([e7d4031](https://github.com/esmevane/rivet/commit/e7d4031f886425d19c549705b5309bb436155da2))
* upgrade actors by build name ([#2741](https://github.com/esmevane/rivet/issues/2741)) ([9eddbd3](https://github.com/esmevane/rivet/commit/9eddbd3f3c409edb594bb5ac5a2d81c37a3906d1))
* use real errors for actor logs ([#2410](https://github.com/esmevane/rivet/issues/2410)) ([6134113](https://github.com/esmevane/rivet/commit/61341130281fbf6eb6e012757ebb3ec797e07749))
* **workflows:** fix race condition of workflow waking before commit ([#2748](https://github.com/esmevane/rivet/issues/2748)) ([3493a1d](https://github.com/esmevane/rivet/commit/3493a1d4b294cd43575ef80fcf8b30009ae413db))
* **workflows:** fix signal publish/listen race condition ([#2742](https://github.com/esmevane/rivet/issues/2742)) ([cb1d4d7](https://github.com/esmevane/rivet/commit/cb1d4d7a5149621fc1f65dea74fb97f401016101))


### Performance Improvements

* migrate to lz4 1.10.0 for parallelized decompression ([#2294](https://github.com/esmevane/rivet/issues/2294)) ([9eac08d](https://github.com/esmevane/rivet/commit/9eac08d1aec3111dc0c0139e21ceaa16b8ca716b))
* **pegboard:** download & extract with raw unix pipes ([#2295](https://github.com/esmevane/rivet/issues/2295)) ([2eac7fc](https://github.com/esmevane/rivet/commit/2eac7fcdcf2950d96497fe40cf53e6c2927ff817))
* **pegboard:** increase page size for passing data from downlaod to lz4 ([#2288](https://github.com/esmevane/rivet/issues/2288)) ([947b7f9](https://github.com/esmevane/rivet/commit/947b7f933b199e16be384928dc7882509677650a))
* **pegboard:** parallelize download image & setup cni network ([#2287](https://github.com/esmevane/rivet/issues/2287)) ([6f8e6a6](https://github.com/esmevane/rivet/commit/6f8e6a6beb58155aeaaac19a4e24d81d1c1c04a6))
* **pegboard:** parallelize writing configs under setup_oci_bundle ([#2289](https://github.com/esmevane/rivet/issues/2289)) ([c1011c5](https://github.com/esmevane/rivet/commit/c1011c5af6a8495fddcb635e4c93bb1a06e6773c))


### Documentation

* add linear-agent-starter example ([#2482](https://github.com/esmevane/rivet/issues/2482)) ([e13e6e9](https://github.com/esmevane/rivet/commit/e13e6e95c56ea63bc73312fa7d01a647412ac507))
* add links to actorcore on rivet ([#2375](https://github.com/esmevane/rivet/issues/2375)) ([d0b1aeb](https://github.com/esmevane/rivet/commit/d0b1aeb20ee6a67e5e893df734e2aa1944d0293d))
* add memory & CPU overcommit section to containers quickstart ([#2693](https://github.com/esmevane/rivet/issues/2693)) ([cc10787](https://github.com/esmevane/rivet/commit/cc10787e5e55a4c56a9e520ce0bb2282864901ef))
* add runInBackground method and update actor lifecycle docs ([#2842](https://github.com/esmevane/rivet/issues/2842)) ([89519b9](https://github.com/esmevane/rivet/commit/89519b910fe2a1921e06e097b42fccbae63a602c))
* add tip on ports & env vars for the dockerfile ([a067ca9](https://github.com/esmevane/rivet/commit/a067ca9337fdf09fefac4d77a4cd5bf93f5a4fdf))
* clarify default port in Rivet Functions ([#2608](https://github.com/esmevane/rivet/issues/2608)) ([335088d](https://github.com/esmevane/rivet/commit/335088d0e7b38be5d029d52556aa8ad8e101b344))
* clean up separation between actors/containers/functions ([#2394](https://github.com/esmevane/rivet/issues/2394)) ([f35b5d5](https://github.com/esmevane/rivet/commit/f35b5d56582538e418ca323f7f2d8c1e72afb689))
* **cli:** add docs for all remaining commands ([#2207](https://github.com/esmevane/rivet/issues/2207)) ([76b2fb5](https://github.com/esmevane/rivet/commit/76b2fb5ebe61ac92c9db1cf92fc592de92febbf6))
* document ci/cd ([#2373](https://github.com/esmevane/rivet/issues/2373)) ([d68999b](https://github.com/esmevane/rivet/commit/d68999b5f5d82b8520a8adcf86e4b70de26d1b97))
* document game server use case ([#2298](https://github.com/esmevane/rivet/issues/2298)) ([11862b4](https://github.com/esmevane/rivet/commit/11862b4c3144b4c713549d51c623b35c3d1c681f))
* document runtime ([#2211](https://github.com/esmevane/rivet/issues/2211)) ([6ae3443](https://github.com/esmevane/rivet/commit/6ae344361498392c2d416109199f422d8542e97d))
* revamp docs ([#2164](https://github.com/esmevane/rivet/issues/2164)) ([6cf3bcf](https://github.com/esmevane/rivet/commit/6cf3bcf0343dffa48d44249339b66188e54efb38))
* simplify sitemap ([#2374](https://github.com/esmevane/rivet/issues/2374)) ([6f03c44](https://github.com/esmevane/rivet/commit/6f03c445a2cb7620e9c633e8624d25f439be7e12))
* temporarily disable npm installation ([6ad6934](https://github.com/esmevane/rivet/commit/6ad6934e5c88fc232f0cb2944b389531d4e900f2))
* update code for functions example ([c103001](https://github.com/esmevane/rivet/commit/c103001087ec87b8286bed1a909b44bab6228ebc))
* update WebSocket handler docs and client type references ([#2791](https://github.com/esmevane/rivet/issues/2791)) ([0b88ac3](https://github.com/esmevane/rivet/commit/0b88ac3c3543158dae60a2f925da75842e313a7e))


### Code Refactoring

* **docs:** update react/js/rust client docs ([#2832](https://github.com/esmevane/rivet/issues/2832)) ([672cc6b](https://github.com/esmevane/rivet/commit/672cc6bb414f104df2320464cfdbff73ec81ec68))
* **hub:** hide actor-core actors inspector when displaying other actors ([#2236](https://github.com/esmevane/rivet/issues/2236)) ([6010c82](https://github.com/esmevane/rivet/commit/6010c826c1094802acef6265f60cdcaf8ea36cc0))
* **hub:** hide rivetkit related tabs from ui ([#2724](https://github.com/esmevane/rivet/issues/2724)) ([d8d3e8e](https://github.com/esmevane/rivet/commit/d8d3e8e4516ad40e02b87086dfbc34d51e1f44ab))
* **hub:** improve actors state sharing ([#2265](https://github.com/esmevane/rivet/issues/2265)) ([8b9c440](https://github.com/esmevane/rivet/commit/8b9c440e55ab2109dad571fb54ebba9165c5da07))
* **hub:** increase level of error reporting to catch cancelled errors ([#2492](https://github.com/esmevane/rivet/issues/2492)) ([2cc1e6e](https://github.com/esmevane/rivet/commit/2cc1e6e11f2da6fe97e022a67ded35a49f76a69e))
* **hub:** make sure user can create actors when manager is present ([#2493](https://github.com/esmevane/rivet/issues/2493)) ([2eb6885](https://github.com/esmevane/rivet/commit/2eb688553bf7998e99f251556d2ceae918ef4ff8))
* **hub:** move off Tanstack Router Context in favour of React Context ([#2255](https://github.com/esmevane/rivet/issues/2255)) ([3aeb800](https://github.com/esmevane/rivet/commit/3aeb80004b75adb31392181e92f9cacf92761993))
* **hub:** polishing ([#2420](https://github.com/esmevane/rivet/issues/2420)) ([677643e](https://github.com/esmevane/rivet/commit/677643ecea49a1363355bcde6f7261f300ce4ac4))
* **hub:** remove instance count for functions ([#2541](https://github.com/esmevane/rivet/issues/2541)) ([fa5deef](https://github.com/esmevane/rivet/commit/fa5deefd70cb473f6be397598ee7cb8947209eb9))
* **hub:** responsive actors table ([#2468](https://github.com/esmevane/rivet/issues/2468)) ([6549759](https://github.com/esmevane/rivet/commit/65497594024d3adce86d628fced9ed27eddec471))
* **hub:** Rivet.actor -&gt; Rivet.actors ([#2233](https://github.com/esmevane/rivet/issues/2233)) ([5badc3f](https://github.com/esmevane/rivet/commit/5badc3f4873318bc1fc88da73b6e1f6c96ff4f40))
* **hub:** sugar coat config tab ([#2490](https://github.com/esmevane/rivet/issues/2490)) ([97d6d62](https://github.com/esmevane/rivet/commit/97d6d62be4e979560269562da70704978c83f6d4))
* **hub:** update billing plans description ([#2263](https://github.com/esmevane/rivet/issues/2263)) ([2d3ec69](https://github.com/esmevane/rivet/commit/2d3ec6950b19f8dfe853c8fb613b989f8e031e3d))
* **hub:** use build tags to determine whenever an actor can have inspector ([#2264](https://github.com/esmevane/rivet/issues/2264)) ([28975f8](https://github.com/esmevane/rivet/commit/28975f8fbdcaa2705ce7dae6f1345fc5c10519b1))
* optimize dx experience for Max ([#2243](https://github.com/esmevane/rivet/issues/2243)) ([f0c46c7](https://github.com/esmevane/rivet/commit/f0c46c7841d2435143af5043bbf539b8725c4f4f))
* remove @rivet-gg/actors ([#2232](https://github.com/esmevane/rivet/issues/2232)) ([f9f47a6](https://github.com/esmevane/rivet/commit/f9f47a6ddf431c65e1e7ef61f3ae693c8c65a24e))
* replace unsafe File::from_raw_fd with safe File::from ([#2479](https://github.com/esmevane/rivet/issues/2479)) ([5c87dae](https://github.com/esmevane/rivet/commit/5c87daeb6d548e25d9815054410106a9d313db78))
* **site:** improve readability ([#2271](https://github.com/esmevane/rivet/issues/2271)) ([1318c02](https://github.com/esmevane/rivet/commit/1318c0283067d0e9c0abbf2f28c7afc834f5c36c))
* use bail_with! macro for actor metrics invalid interval ([#2669](https://github.com/esmevane/rivet/issues/2669)) ([9e3dbb1](https://github.com/esmevane/rivet/commit/9e3dbb1e18514923c55287898e4f061358c494d9))


### Continuous Integration

* configure git config globally ([#2390](https://github.com/esmevane/rivet/issues/2390)) ([433074c](https://github.com/esmevane/rivet/commit/433074c0392d51f2001fb32d19c9eca8c49f0f98))
* fix actor-core dependency in ci ([0c8a1ef](https://github.com/esmevane/rivet/commit/0c8a1ef5eafdedad7f3b68faca6ebb9fdb73e1f0))
* temporarily disable windows builds ([#2392](https://github.com/esmevane/rivet/issues/2392)) ([117b838](https://github.com/esmevane/rivet/commit/117b83825b05d73d36969fb69f17d2270add59a1))


### Chores

* a mess of merging everything together ([#2720](https://github.com/esmevane/rivet/issues/2720)) ([4646b83](https://github.com/esmevane/rivet/commit/4646b835e137327d7ca61ccdd64e13b5791c2b19))
* add --non-interactive flag to rivet deploy commands ([#2658](https://github.com/esmevane/rivet/issues/2658)) ([b8b80e3](https://github.com/esmevane/rivet/commit/b8b80e3e5f27046c3270c71b305b81ac9d1af20d))
* add ahrefs analytics ([#2675](https://github.com/esmevane/rivet/issues/2675)) ([9f50c70](https://github.com/esmevane/rivet/commit/9f50c70dd099e67bf1499ea0ce90ba8802bf4bd2))
* add ahrefs analytics to site ([#2677](https://github.com/esmevane/rivet/issues/2677)) ([5e9b473](https://github.com/esmevane/rivet/commit/5e9b473166755b91b2b4dacaa60d568a76f36ec3))
* add architecture docs ([#2798](https://github.com/esmevane/rivet/issues/2798)) ([e636233](https://github.com/esmevane/rivet/commit/e6362338541a7a9f89f27fbfc1a8c56942b1b23e))
* add cargo fmt precommit hook ([#2666](https://github.com/esmevane/rivet/issues/2666)) ([c90883d](https://github.com/esmevane/rivet/commit/c90883dad9feeb04d19761235f19de059909c287))
* add config validation command ([#2195](https://github.com/esmevane/rivet/issues/2195)) ([6bd1a60](https://github.com/esmevane/rivet/commit/6bd1a60cedbd629bd8c985be1a3417e51394c6c8))
* add copy as markdown, preserve sidebar dropdown state, landing page tweaks ([#2763](https://github.com/esmevane/rivet/issues/2763)) ([d0fc1c8](https://github.com/esmevane/rivet/commit/d0fc1c8a68dd3719b3ea47255309363056992d86))
* add dev edge to justfile ([#2319](https://github.com/esmevane/rivet/issues/2319)) ([86bf47d](https://github.com/esmevane/rivet/commit/86bf47d3472b45c7ab34e50e45b35b3a3f349615))
* add enterprise flags for rivet cloud ([#2799](https://github.com/esmevane/rivet/issues/2799)) ([94704d4](https://github.com/esmevane/rivet/commit/94704d4e66cbe9d0fc5fd4aa8ec4b7423bf9a922))
* add fdb metrics ([#2176](https://github.com/esmevane/rivet/issues/2176)) ([5abeedb](https://github.com/esmevane/rivet/commit/5abeedb3620affe4414f7739ce1fb7d692026b32))
* add Linux ARM64 and Windows build targets ([#2551](https://github.com/esmevane/rivet/issues/2551)) ([7ea58ca](https://github.com/esmevane/rivet/commit/7ea58caab715f50e06a0f6a9c7aabdc4debf362a))
* add logging & duration metrics to pegboard setup ([#2291](https://github.com/esmevane/rivet/issues/2291)) ([3c04bec](https://github.com/esmevane/rivet/commit/3c04bec11670ab5d4b8d37123f1653f31af9310d))
* add mobile nav & code snippets layout ([#2753](https://github.com/esmevane/rivet/issues/2753)) ([21fb11e](https://github.com/esmevane/rivet/commit/21fb11e22fc6ffe4e5dbfde3e96f0f735d5f4e44))
* add open-source durable objects to landing page ([#2514](https://github.com/esmevane/rivet/issues/2514)) ([941b6ac](https://github.com/esmevane/rivet/commit/941b6ace404cabecfd41277917dd86d0657f4c63))
* add pnp for esbuild ([00f87b9](https://github.com/esmevane/rivet/commit/00f87b985d8a6de0701bad42dac8c7ee9f9d208c))
* add quickstart index page ([#2759](https://github.com/esmevane/rivet/issues/2759)) ([6cfd757](https://github.com/esmevane/rivet/commit/6cfd7576099dcdcbd9cabe0f51442ea3e511cc34))
* add sandboxed-code-execution demo for js & container ([#2165](https://github.com/esmevane/rivet/issues/2165)) ([9d90db3](https://github.com/esmevane/rivet/commit/9d90db3a7d71e96c5bcc2a7beac77a8f976c59c5))
* add script to distribute lz4 binary ([#2293](https://github.com/esmevane/rivet/issues/2293)) ([601075a](https://github.com/esmevane/rivet/commit/601075a421850176e49d72c81003ff19e3098b21))
* add sitemap ([#2737](https://github.com/esmevane/rivet/issues/2737)) ([d083bf5](https://github.com/esmevane/rivet/commit/d083bf554f0ad1f72872bb1af2f3888170c4842b))
* add standalone toolchain build scripts ([#2400](https://github.com/esmevane/rivet/issues/2400)) ([7e3b07e](https://github.com/esmevane/rivet/commit/7e3b07ec2c41e00006d105b7e0e56d898e70338f))
* add talk to an engineer page ([#2756](https://github.com/esmevane/rivet/issues/2756)) ([c827b91](https://github.com/esmevane/rivet/commit/c827b91173932ecb08f8d61f81774bbe26c7914b))
* add tls config to rivet guard ([#2279](https://github.com/esmevane/rivet/issues/2279)) ([bc0582f](https://github.com/esmevane/rivet/commit/bc0582f0da5241275bdfe5631c77cb0765977c5d))
* add typesense search ([#2764](https://github.com/esmevane/rivet/issues/2764)) ([6705af9](https://github.com/esmevane/rivet/commit/6705af9525e640e14978beefac2140098112ea39))
* add w3c spec blog ([#2251](https://github.com/esmevane/rivet/issues/2251)) ([652973b](https://github.com/esmevane/rivet/commit/652973bbaad2f337aa363ce71c792a8af9eef5d1))
* **api-actor:** don't attempt to contact edge dcs without worker nodes ([#2290](https://github.com/esmevane/rivet/issues/2290)) ([b124428](https://github.com/esmevane/rivet/commit/b124428ca787192518df42e1dc00fe0cce1fd7f0))
* **api-actor:** handle no edge regions gracefully ([#2318](https://github.com/esmevane/rivet/issues/2318)) ([97a0110](https://github.com/esmevane/rivet/commit/97a01102e18ae5e32261066c0e87426d920523e7))
* **api-actor:** increase default rate limits ([#2311](https://github.com/esmevane/rivet/issues/2311)) ([8574269](https://github.com/esmevane/rivet/commit/857426926484f06ada210ff1a6c1e3c0ccf36ea6))
* auto-generate dockerfile for rivetkit ([#2659](https://github.com/esmevane/rivet/issues/2659)) ([1ad2a2a](https://github.com/esmevane/rivet/commit/1ad2a2a7ebb595888b8aed8096a684fc5a0f4a69))
* auto-generate readme examples ([#2792](https://github.com/esmevane/rivet/issues/2792)) ([7f55187](https://github.com/esmevane/rivet/commit/7f55187b10c58479d504d51d29c792e4c228f8d3))
* build edge binaries in release mode ([#2292](https://github.com/esmevane/rivet/issues/2292)) ([65ee768](https://github.com/esmevane/rivet/commit/65ee7681c819a048c8263c3c785f267432ce3dc0))
* cargo fmt ([#2665](https://github.com/esmevane/rivet/issues/2665)) ([3a8cb86](https://github.com/esmevane/rivet/commit/3a8cb86b0029c068e406f06ae1ce3e72d11e0fcf))
* change open in chatgpt/claude to use url instead of full markdown text ([#2766](https://github.com/esmevane/rivet/issues/2766)) ([0097f67](https://github.com/esmevane/rivet/commit/0097f678c6fbf3a26fcbb1c625b61de31a023cc5))
* change otel collector policies ([#2436](https://github.com/esmevane/rivet/issues/2436)) ([bb8ccd5](https://github.com/esmevane/rivet/commit/bb8ccd548353180820ade4253ac7a8d249bc7aff))
* changelog cli ([#2191](https://github.com/esmevane/rivet/issues/2191)) ([ef51dc2](https://github.com/esmevane/rivet/commit/ef51dc218fda20f6c9ad8ff5b190dd607d7fb40e))
* clean up mdx components ([#2769](https://github.com/esmevane/rivet/issues/2769)) ([a86abce](https://github.com/esmevane/rivet/commit/a86abce8fe8d21e782017a966aedddc0f283e0cd))
* clean up nav ([#2776](https://github.com/esmevane/rivet/issues/2776)) ([97e7f7e](https://github.com/esmevane/rivet/commit/97e7f7e4a093b6340aeb0da6e5aaee55289f2663))
* clean up nav styling ([#2751](https://github.com/esmevane/rivet/issues/2751)) ([9b48931](https://github.com/esmevane/rivet/commit/9b48931503a83e06d649d415cdbf25fe529b6635))
* clean up remaining docs ([#2770](https://github.com/esmevane/rivet/issues/2770)) ([497c855](https://github.com/esmevane/rivet/commit/497c8550edeb8af6e9c544a9c131cd39ad278c40))
* **cli:** allow RIVET_CLI_VERSION override for installed CLI version ([#2426](https://github.com/esmevane/rivet/issues/2426)) ([ecdd6c8](https://github.com/esmevane/rivet/commit/ecdd6c8bce5d7d4ab364dae2a18ccb5b0a52e7e9))
* **cli:** remove `BuildAccess` config ([#2208](https://github.com/esmevane/rivet/issues/2208)) ([81c62b5](https://github.com/esmevane/rivet/commit/81c62b5824929faee6f97513f1f3020aa3559cb3))
* dim platform icons ([#2736](https://github.com/esmevane/rivet/issues/2736)) ([8ad23b1](https://github.com/esmevane/rivet/commit/8ad23b1585f589dc56f4248dfbf063b221722574))
* disable building hub in docker container ([#2317](https://github.com/esmevane/rivet/issues/2317)) ([9a2ac65](https://github.com/esmevane/rivet/commit/9a2ac652c7e208672bae89e652938aafbfcffaeb))
* disable otel ([#2244](https://github.com/esmevane/rivet/issues/2244)) ([79cd271](https://github.com/esmevane/rivet/commit/79cd2718e7b34615c5abe61c4827a4427a4351b7))
* disable OTEL by default in guard service ([#2522](https://github.com/esmevane/rivet/issues/2522)) ([1e6fef3](https://github.com/esmevane/rivet/commit/1e6fef392aac4fcad481d3914379827fa10b6e8e))
* disable publishing cli since it's broken ([46bfeff](https://github.com/esmevane/rivet/commit/46bfeffbdec6a9aaa8dd797ad5abd9fb520fa702))
* document fetch & ws handler ([#2767](https://github.com/esmevane/rivet/issues/2767)) ([834b7d1](https://github.com/esmevane/rivet/commit/834b7d1be423f9404c0c3d776bee1b05ea953ae7))
* **examples:** multitenant deploys example ([#2527](https://github.com/esmevane/rivet/issues/2527)) ([183ca27](https://github.com/esmevane/rivet/commit/183ca276a76d93438bb25544265d53c93d9356d3))
* **examples:** remove old configs ([#2206](https://github.com/esmevane/rivet/issues/2206)) ([f2a0bb4](https://github.com/esmevane/rivet/commit/f2a0bb48b237522e4284191ff025f9b5c85d4a4d))
* expose namespace in otel attributes ([#2501](https://github.com/esmevane/rivet/issues/2501)) ([b208feb](https://github.com/esmevane/rivet/commit/b208febfc829ff14295f56d0014b015515e930b5))
* fill out remaining content for landing page ([#2413](https://github.com/esmevane/rivet/issues/2413)) ([e0fecf1](https://github.com/esmevane/rivet/commit/e0fecf12fc3064626798de9c34b055d69f3476df))
* fix active active page in router ([#2762](https://github.com/esmevane/rivet/issues/2762)) ([a87caf8](https://github.com/esmevane/rivet/commit/a87caf864b75408e003e7a87db4b7992ecee3551))
* fix actor-core path ([198c963](https://github.com/esmevane/rivet/commit/198c963e770a25dd87656fea3ed78fdaeb98e966))
* fix api docs ([#2209](https://github.com/esmevane/rivet/issues/2209)) ([7363327](https://github.com/esmevane/rivet/commit/73633276170a43ea5f67c21907ba416dff1feeac))
* fix broadcast req error logs ([#2419](https://github.com/esmevane/rivet/issues/2419)) ([5f2cfaa](https://github.com/esmevane/rivet/commit/5f2cfaa0db51009c6029737fe4be679795732763))
* fix broken links ([f7907d7](https://github.com/esmevane/rivet/commit/f7907d747a3236cb22bb9ee4f39f8d21334e2a68))
* fix broken links ([6f1ef12](https://github.com/esmevane/rivet/commit/6f1ef1228ea8caf96621b28e1c3ec9c4e84689c0))
* fix broken links ([8357a2c](https://github.com/esmevane/rivet/commit/8357a2c3633c5892d526025205d8ead32592e73f))
* fix broken links ([fe1cffd](https://github.com/esmevane/rivet/commit/fe1cffd97496b6e65a6d8d2eccb884df83c5adcd))
* fix broken links ([#2734](https://github.com/esmevane/rivet/issues/2734)) ([a99678c](https://github.com/esmevane/rivet/commit/a99678ce3acd047647f2360c124f4f537636d324))
* fix building hub archive ([#2368](https://github.com/esmevane/rivet/issues/2368)) ([37f42ce](https://github.com/esmevane/rivet/commit/37f42ce7e32d50c0d62247325d72a9969ff6c551))
* fix building site for cf ([#2757](https://github.com/esmevane/rivet/issues/2757)) ([8710efb](https://github.com/esmevane/rivet/commit/8710efb96443e45c3e3f650794b024a1e86c105a))
* fix dc wf ([#2552](https://github.com/esmevane/rivet/issues/2552)) ([9e9363e](https://github.com/esmevane/rivet/commit/9e9363e3f519a2a29734bccf57cb3c50de4ee689))
* fix docs links in actor list ([#2315](https://github.com/esmevane/rivet/issues/2315)) ([9a0eea2](https://github.com/esmevane/rivet/commit/9a0eea2b644d3030c06a984c3bef2bdc97d3499d))
* fix guard metrics ([#2504](https://github.com/esmevane/rivet/issues/2504)) ([fa2f84f](https://github.com/esmevane/rivet/commit/fa2f84f0ea29cbd0d1295da2ec14368380117b1b))
* fix landing page links ([#2452](https://github.com/esmevane/rivet/issues/2452)) ([24a03dc](https://github.com/esmevane/rivet/commit/24a03dc2929ad1058bec72bc0e214862a68dfd28))
* fix links in linear agent blog post ([f0ce79f](https://github.com/esmevane/rivet/commit/f0ce79f261c0632296b6b4c01463b479ccc207e8))
* fix mobile layout on landing page ([#2754](https://github.com/esmevane/rivet/issues/2754)) ([714a597](https://github.com/esmevane/rivet/commit/714a597d478cb3509fc6fcbb6cd750144b2ef297))
* fix otel config for guard ([#2371](https://github.com/esmevane/rivet/issues/2371)) ([9f645c0](https://github.com/esmevane/rivet/commit/9f645c0c8ed133d616cfbf5b61c15f92abab0eb1))
* fix paths to sandboxed code execution examples ([#2381](https://github.com/esmevane/rivet/issues/2381)) ([564a402](https://github.com/esmevane/rivet/commit/564a40271d9ebc404b1157a291cb6ec3b1716f9e))
* fix peer deps ([520b83c](https://github.com/esmevane/rivet/commit/520b83cbd5eed8ec8462a34e584aea21db00e92c))
* fix quickstart & update hotsing providers links ([#2777](https://github.com/esmevane/rivet/issues/2777)) ([a0ac16e](https://github.com/esmevane/rivet/commit/a0ac16e979e7aba945a24e12eeff622738f0324d))
* fix railway link ([#2785](https://github.com/esmevane/rivet/issues/2785)) ([041c519](https://github.com/esmevane/rivet/commit/041c519eb04ff127eee35ccc9c0abaeb7ea41998))
* fix rust example ([#2386](https://github.com/esmevane/rivet/issues/2386)) ([8d23b40](https://github.com/esmevane/rivet/commit/8d23b4048c2cd574ed17aaa79a54e358f4a0be1b))
* fix steps styling ([#2755](https://github.com/esmevane/rivet/issues/2755)) ([1e2384a](https://github.com/esmevane/rivet/commit/1e2384ae754f116a68e3792abc41dbe0fea86772))
* fix typo ([#2516](https://github.com/esmevane/rivet/issues/2516)) ([9fdd868](https://github.com/esmevane/rivet/commit/9fdd86826def1803b2ebb5fd5166aa6237b1fe01))
* fix update version ([#2686](https://github.com/esmevane/rivet/issues/2686)) ([25969da](https://github.com/esmevane/rivet/commit/25969da2ef25432e813f9627281bfc31e1b2b371))
* fix vercel routing ([#2760](https://github.com/esmevane/rivet/issues/2760)) ([2122969](https://github.com/esmevane/rivet/commit/212296916702dc1a347daf0f74a913b0e8753493))
* fixes to pricing page ([#2459](https://github.com/esmevane/rivet/issues/2459)) ([a207c1f](https://github.com/esmevane/rivet/commit/a207c1fc5976532fd0a1346fb883f8fa79da2d89))
* flatten examples ([#2181](https://github.com/esmevane/rivet/issues/2181)) ([76a3602](https://github.com/esmevane/rivet/commit/76a3602fc118627c7717468da62ce8c6caff953a))
* fmt ([#2706](https://github.com/esmevane/rivet/issues/2706)) ([df3292a](https://github.com/esmevane/rivet/commit/df3292a7c51d0499f168549d5f4d1434356b11e9))
* force update hub ([0449ead](https://github.com/esmevane/rivet/commit/0449eadac329206f2672126e47586d123407a4b8))
* functions blog ([#2581](https://github.com/esmevane/rivet/issues/2581)) ([d993c81](https://github.com/esmevane/rivet/commit/d993c81e07de784fbe4add79f4062d88d2f5aa3d))
* **guard:** fix log levels ([#2580](https://github.com/esmevane/rivet/issues/2580)) ([c1c57ff](https://github.com/esmevane/rivet/commit/c1c57ffe000ff4bbc24f5693eb13cf06e626766d))
* **hub:** update actor framework filters for rivetkit ([#2656](https://github.com/esmevane/rivet/issues/2656)) ([fa1f776](https://github.com/esmevane/rivet/commit/fa1f77683dd5a32ad58d3716b9b9e1008206d393))
* improve fetch & websocket handler ([#2771](https://github.com/esmevane/rivet/issues/2771)) ([8c96b2e](https://github.com/esmevane/rivet/commit/8c96b2e7e63c6ef33f809d7d6b640071e5162e05))
* improve traces ([#2343](https://github.com/esmevane/rivet/issues/2343)) ([a7d1598](https://github.com/esmevane/rivet/commit/a7d15980a0337ddee98fb2bf67ffd1767ff71b10))
* increase default rate limit for Rivet Guard ([#2226](https://github.com/esmevane/rivet/issues/2226)) ([4d711ca](https://github.com/esmevane/rivet/commit/4d711ca6011f15591e19832399a3d83312574c1b))
* increase file watch limit for rivet guard ([#2521](https://github.com/esmevane/rivet/issues/2521)) ([38528db](https://github.com/esmevane/rivet/commit/38528dbbc7658f767d7343c7dbe1f5b5233ef964))
* install before publishing ([6762d8c](https://github.com/esmevane/rivet/commit/6762d8c315aee896bf44322e67c9ca6baf51c7c0))
* link to websocket examples ([#2779](https://github.com/esmevane/rivet/issues/2779)) ([5aa1a77](https://github.com/esmevane/rivet/commit/5aa1a77e1da9c6dcf916aa033e0d02e80cdbc996))
* **main:** release 25.2.1 ([#2154](https://github.com/esmevane/rivet/issues/2154)) ([74a9c70](https://github.com/esmevane/rivet/commit/74a9c70e995d64f2422bdbda466e333901cf89f7))
* **main:** release 25.2.2 ([#2219](https://github.com/esmevane/rivet/issues/2219)) ([c0a769d](https://github.com/esmevane/rivet/commit/c0a769d6e913a1825c88ab5df7b6283a36c54ae1))
* **main:** release 25.3.0 ([#2285](https://github.com/esmevane/rivet/issues/2285)) ([08ef18e](https://github.com/esmevane/rivet/commit/08ef18e3086a669e1502d70651494149ac919e40))
* **main:** release 25.3.1 ([#2300](https://github.com/esmevane/rivet/issues/2300)) ([adef331](https://github.com/esmevane/rivet/commit/adef331e4fec55b8c7ab610258748f6e85af983d))
* **main:** release 25.4.0 ([#2302](https://github.com/esmevane/rivet/issues/2302)) ([320eb1b](https://github.com/esmevane/rivet/commit/320eb1bd4e159bd43662fa3f469af30dde657dd6))
* **main:** release 25.4.0 ([#2402](https://github.com/esmevane/rivet/issues/2402)) ([844cd7d](https://github.com/esmevane/rivet/commit/844cd7d93a2fe9809a8d822717d21a6dda45fa1d))
* **main:** release 25.4.1 ([#2405](https://github.com/esmevane/rivet/issues/2405)) ([a6334c7](https://github.com/esmevane/rivet/commit/a6334c7123cd23e6a1b9ad17d165348d2ccdc960))
* **main:** release 25.5.1 ([#2423](https://github.com/esmevane/rivet/issues/2423)) ([9a28ea0](https://github.com/esmevane/rivet/commit/9a28ea0063cad661511482d831145f99bcedc936))
* **main:** release 25.5.2 ([#2728](https://github.com/esmevane/rivet/issues/2728)) ([65c279f](https://github.com/esmevane/rivet/commit/65c279f5fe6e387a8a4b148166b47ebf466e1216))
* make site full width ([#2752](https://github.com/esmevane/rivet/issues/2752)) ([51278d1](https://github.com/esmevane/rivet/commit/51278d1ba8efe4c4594d426663750ab35c526fcc))
* manifesto and changelog update ([#2200](https://github.com/esmevane/rivet/issues/2200)) ([688eed1](https://github.com/esmevane/rivet/commit/688eed1a21e073784452b44ea9a7f6ad758b1dcf))
* mark LLM lists and docs as generated files ([#2788](https://github.com/esmevane/rivet/issues/2788)) ([a4ed08d](https://github.com/esmevane/rivet/commit/a4ed08de62d2087aa9327c2b772f6c8a86cb7595))
* migrate redirects from file to Next.js config ([#2789](https://github.com/esmevane/rivet/issues/2789)) ([da00ff5](https://github.com/esmevane/rivet/commit/da00ff59ded66893ab68ff763cf2148c27e410b5))
* move apis to workspace ([3b304c3](https://github.com/esmevane/rivet/commit/3b304c34a1a8e36e1d21f0dea630d57f7499943d))
* moved tailwind v2 -&gt; main config ([#2750](https://github.com/esmevane/rivet/issues/2750)) ([a1641eb](https://github.com/esmevane/rivet/commit/a1641eb3ef88cc65f69c744c35c3b0b420c956e7))
* new landing page ([#2369](https://github.com/esmevane/rivet/issues/2369)) ([cd66a6d](https://github.com/esmevane/rivet/commit/cd66a6d6f7ebe99aa52403b646952ea1a0b78fbe))
* new og image ([#2450](https://github.com/esmevane/rivet/issues/2450)) ([14c45eb](https://github.com/esmevane/rivet/commit/14c45ebabf0e7da3edabfcca7315f6137273272f))
* og image ([#2222](https://github.com/esmevane/rivet/issues/2222)) ([0df741c](https://github.com/esmevane/rivet/commit/0df741c48dd6466124c19e0a1ec875296f5d07f9))
* page description optimization ([#2584](https://github.com/esmevane/rivet/issues/2584)) ([b6524d9](https://github.com/esmevane/rivet/commit/b6524d90dcc762540acc6c22fa56750920784531))
* **pegboard:** add workaround fetching image size when not using ats ([#2744](https://github.com/esmevane/rivet/issues/2744)) ([386da9f](https://github.com/esmevane/rivet/commit/386da9f61cefd6ef1c322e29022a368dac348ee5))
* **pegboard:** fix local cache bugs ([#2596](https://github.com/esmevane/rivet/issues/2596)) ([496c391](https://github.com/esmevane/rivet/commit/496c391b8c1c5822fe042fa9ca8ab89c4caeb12e))
* **pegboard:** send artifact image size from workflow instead of fetching with HEAD ([#2612](https://github.com/esmevane/rivet/issues/2612)) ([4969582](https://github.com/esmevane/rivet/commit/49695829c9548da58d3151bce36aac6f3e4af8c8))
* pricing update ([#2455](https://github.com/esmevane/rivet/issues/2455)) ([efcd3fd](https://github.com/esmevane/rivet/commit/efcd3fdaa1618c55e57a5fa394ac10af7019a72e))
* pricing update ([#2591](https://github.com/esmevane/rivet/issues/2591)) ([b16d098](https://github.com/esmevane/rivet/commit/b16d098922fc598326288282f934b2095b6d151a))
* re-enable building windows x86 toolchain ([#2616](https://github.com/esmevane/rivet/issues/2616)) ([b03c6f7](https://github.com/esmevane/rivet/commit/b03c6f7d638e90e92b83dbeee445f9bc73188170))
* reduce actor metrics poll interval and increase data points ([#2670](https://github.com/esmevane/rivet/issues/2670)) ([c6c6948](https://github.com/esmevane/rivet/commit/c6c6948b6c7bf77dd0a4f80f34990aff8d1c87b2))
* release 25.2.1 ([7a41802](https://github.com/esmevane/rivet/commit/7a4180205598624c66b48089530763e12abeadf4))
* release 25.2.1 ([344ed3c](https://github.com/esmevane/rivet/commit/344ed3c20242e708700d7f097111fd665b31e26d))
* release 25.2.1 ([306f48d](https://github.com/esmevane/rivet/commit/306f48dc0abe2d4171e97b520ebfff91dc9aa7f5))
* release 25.2.1 ([3b3a112](https://github.com/esmevane/rivet/commit/3b3a112d235468136ed42243e29a6d04219b5a42))
* release 25.2.1 ([d233338](https://github.com/esmevane/rivet/commit/d233338596455542bc736a697de95953afe73739))
* release 25.2.1 ([d1e4eb4](https://github.com/esmevane/rivet/commit/d1e4eb4c87375878f1c568a42ad09bf05cb847f4))
* release 25.2.1 ([3768a7d](https://github.com/esmevane/rivet/commit/3768a7dad048ab9e0a0a8beb63efd192361478a5))
* release 25.2.1 ([ab5dc69](https://github.com/esmevane/rivet/commit/ab5dc69058601bdc6eb64c578f3be61dec328675))
* release 25.2.1 ([5efe76b](https://github.com/esmevane/rivet/commit/5efe76b8e67694fdaed97741812c7f37d886d90e))
* release 25.2.2 ([d17ecf4](https://github.com/esmevane/rivet/commit/d17ecf488527e4a31c5446f11fcf00b2516dcb15))
* release 25.2.2 ([cf81b35](https://github.com/esmevane/rivet/commit/cf81b354c94120e3219b250a00f629e49bea7578))
* release 25.3.1 ([cdf53d3](https://github.com/esmevane/rivet/commit/cdf53d36f03d72c145373e1391645ca1ce98e8ab))
* release 25.4.0 ([3d3c60e](https://github.com/esmevane/rivet/commit/3d3c60e5f178accf7995c2e79482d13c1e6dc084))
* release 25.4.0 ([1f1b9c5](https://github.com/esmevane/rivet/commit/1f1b9c52341f990a703b55ece9464b7ca92676ba))
* release 25.4.1 ([6289acb](https://github.com/esmevane/rivet/commit/6289acbea932704040a0e3433d936391e769ebbe))
* release 25.4.1 ([ff549fe](https://github.com/esmevane/rivet/commit/ff549fe7d58b95baed0e65e7da61b5bfa5e4c671))
* release 25.4.2 ([3924250](https://github.com/esmevane/rivet/commit/392425013fac42001fdc4f5176e393ca593e68c1))
* release 25.4.2 ([dc4c2cf](https://github.com/esmevane/rivet/commit/dc4c2cfd908503d046635bd45cc918e4f0e9c7fa))
* release 25.5.0 ([80902bc](https://github.com/esmevane/rivet/commit/80902bcf3867352a5e39330cd4247bb14910c663))
* release 25.5.1 ([3671810](https://github.com/esmevane/rivet/commit/3671810d6e9bd65389a78c87e6ddb3230017a4e5))
* release 25.5.1 ([3528157](https://github.com/esmevane/rivet/commit/3528157a6988ac4865b5bbacc32247f58b38e935))
* release 25.5.2 ([d8ffbf0](https://github.com/esmevane/rivet/commit/d8ffbf0c8e198a650f0a5d94584ea0e85d3498a3))
* release 25.5.2 ([b210f39](https://github.com/esmevane/rivet/commit/b210f39177325b5b8cf4f70e18a89bf32ddb21f4))
* release 25.5.3 ([a07577d](https://github.com/esmevane/rivet/commit/a07577d83a0ca8362f760fd108b461fd5ec6f965))
* **release:** update version to 25.2.1 ([0989257](https://github.com/esmevane/rivet/commit/09892576c497fe265eec897790b79c465b258b9c))
* **release:** update version to 25.2.1 ([875c7ad](https://github.com/esmevane/rivet/commit/875c7ad800aeac352d3c90da9daf34aad1deda27))
* **release:** update version to 25.2.1 ([e598b6d](https://github.com/esmevane/rivet/commit/e598b6ddbf60c912ea1d94a04c2950e09dc46cbd))
* **release:** update version to 25.2.1 ([b901253](https://github.com/esmevane/rivet/commit/b901253b0f99f75545a2960f962bd4186f98f9d8))
* **release:** update version to 25.2.1 ([62afbfe](https://github.com/esmevane/rivet/commit/62afbfe0acd1c07001d749c0b4fb841dfbbe7e41))
* **release:** update version to 25.2.1 ([5dc75ce](https://github.com/esmevane/rivet/commit/5dc75ce6753cd21a0efcd01df1ebc176eeff9a74))
* **release:** update version to 25.2.1 ([4eb83de](https://github.com/esmevane/rivet/commit/4eb83de01ab13e9409975a4dddb45a14ea3c4803))
* **release:** update version to 25.2.1 ([24cdfc5](https://github.com/esmevane/rivet/commit/24cdfc5339dee2e4a81f407193c62d8876c998c9))
* **release:** update version to 25.2.1 ([916df87](https://github.com/esmevane/rivet/commit/916df8758958f179e4ff787549ee47eac4361330))
* **release:** update version to 25.2.2 ([bd72622](https://github.com/esmevane/rivet/commit/bd726221bcef21b4d73b9e02571157bd75ceddd0))
* **release:** update version to 25.2.2 ([9faa4cc](https://github.com/esmevane/rivet/commit/9faa4cccc9a5833e2eedb14420f467d78e4672cc))
* **release:** update version to 25.4.0 ([adb7f90](https://github.com/esmevane/rivet/commit/adb7f908f42d99ceb17ebb7441a21daf40e76422))
* **release:** update version to 25.4.0 ([90d409a](https://github.com/esmevane/rivet/commit/90d409ab25bd374bc01ef2c09de023175b194d65))
* **release:** update version to 25.4.1 ([00f48ed](https://github.com/esmevane/rivet/commit/00f48edc8400d7c044dd126483f1526e3398ad50))
* **release:** update version to 25.4.1 ([2ca67f2](https://github.com/esmevane/rivet/commit/2ca67f2463b7fff393403d6a2187170b35c83c37))
* **release:** update version to 25.4.2 ([e6a665f](https://github.com/esmevane/rivet/commit/e6a665fca65f8593f9e59ccb409146f4ba5d3013))
* **release:** update version to 25.4.2 ([89d12ce](https://github.com/esmevane/rivet/commit/89d12ce6fdf6a9f404d9dd271adc9e58904b2752))
* **release:** update version to 25.5.0 ([08cbf90](https://github.com/esmevane/rivet/commit/08cbf904d7493ec50981a98b64e088fe07a0715e))
* **release:** update version to 25.5.1 ([d04aeea](https://github.com/esmevane/rivet/commit/d04aeea8260d07f01cc0835fbb19ffbdc6430f8e))
* **release:** update version to 25.5.1 ([5f350ea](https://github.com/esmevane/rivet/commit/5f350ea64505fc80156e901b8252e6b6a5667cbe))
* **release:** update version to 25.5.2 ([88d4760](https://github.com/esmevane/rivet/commit/88d4760834de2bd92a5d5be17eb1e67a5e019acc))
* **release:** update version to 25.5.2 ([5e03f9e](https://github.com/esmevane/rivet/commit/5e03f9eff94c706839889eaa1ec5a6e917d476fc))
* **release:** update version to 25.5.3 ([2380933](https://github.com/esmevane/rivet/commit/2380933a8a9730304e1347d5b936ff567db2ba16))
* remove @rivet-gg/cli from release temporarily ([08f5934](https://github.com/esmevane/rivet/commit/08f5934028e6c54c04b52b34258c8a3d5aa4016f))
* remove `rivet init1 from readme ([93ab2f8](https://github.com/esmevane/rivet/commit/93ab2f8950aa0659f8089581ec7114f7e45c965f))
* remove actors sdk in favor of actorcore ([#2199](https://github.com/esmevane/rivet/issues/2199)) ([ee7693b](https://github.com/esmevane/rivet/commit/ee7693ba7fb93b6a648f7e9e71586ad83eb6f786))
* remove init command ([#2198](https://github.com/esmevane/rivet/issues/2198)) ([b215811](https://github.com/esmevane/rivet/commit/b21581181f35f86f1ef8a1a0cd14c13f89038da6))
* remove isolate-v8-runner from Docker repos ([#2684](https://github.com/esmevane/rivet/issues/2684)) ([fc15db0](https://github.com/esmevane/rivet/commit/fc15db0e7178f367d85050b4fba27f014f61fbc2))
* remove old references to matchmaker on website for seo ([#2511](https://github.com/esmevane/rivet/issues/2511)) ([8ccd8a1](https://github.com/esmevane/rivet/commit/8ccd8a1f357b5cc63aad94741ac3ab555ce9c9c6))
* remove outdated better stack integration ([#2680](https://github.com/esmevane/rivet/issues/2680)) ([63758a3](https://github.com/esmevane/rivet/commit/63758a3666fa31949390429606f677267fd83498))
* rename actor -&gt; actors in sdk for consistency ([#2197](https://github.com/esmevane/rivet/issues/2197)) ([479ac9a](https://github.com/esmevane/rivet/commit/479ac9a5be2b4fb77ac7a3a889fd97185e4a1cb1))
* rename actor.regions.resolve to actor.regions.recommend ([#2196](https://github.com/esmevane/rivet/issues/2196)) ([b28003d](https://github.com/esmevane/rivet/commit/b28003dca4f7a7701414ee7920e07fa133512fd1))
* replace `hub-embed` with proxy to 127.0.0.1:5080 for /ui/ path in dev ([#2615](https://github.com/esmevane/rivet/issues/2615)) ([7e7c582](https://github.com/esmevane/rivet/commit/7e7c582fd9603ac39a8cfa17487dbd18b8820747))
* revert billing ([#2549](https://github.com/esmevane/rivet/issues/2549)) ([afbbfe3](https://github.com/esmevane/rivet/commit/afbbfe352de2c3076eff5cc67913ef859c6712df))
* rivetkit blog ([#2681](https://github.com/esmevane/rivet/issues/2681)) ([e526230](https://github.com/esmevane/rivet/commit/e526230a5fbcce9f9ed3d66051356b8f422b4b01))
* **site:** add examples to landing page ([#2747](https://github.com/esmevane/rivet/issues/2747)) ([cb555da](https://github.com/esmevane/rivet/commit/cb555da48787648069726afc81a4a8e21972cc4e))
* **site:** doc new useActor properties ([#2808](https://github.com/esmevane/rivet/issues/2808)) ([db39a0d](https://github.com/esmevane/rivet/commit/db39a0d417f64055584c567c9f1ac6b9990d4780))
* **site:** remove actor-core dep ([d4205a9](https://github.com/esmevane/rivet/commit/d4205a94774adb73208d40bf4e31fc30fe8a0329))
* **site:** remove deprecated errors ([#2606](https://github.com/esmevane/rivet/issues/2606)) ([fde245d](https://github.com/esmevane/rivet/commit/fde245d5b91a905ed65ccf5c7f991b3aea2d3c1e))
* **site:** update docs nav scrolling ([#2796](https://github.com/esmevane/rivet/issues/2796)) ([7e80a18](https://github.com/esmevane/rivet/commit/7e80a18bfae0e1bfa579581b23bf8c49c0502a9a))
* **site:** update docs on new lifecycle hooks ([#2843](https://github.com/esmevane/rivet/issues/2843)) ([f879623](https://github.com/esmevane/rivet/commit/f879623b871e4acafaffd31817b9386fb84ddce1))
* **site:** update react docs ([#2806](https://github.com/esmevane/rivet/issues/2806)) ([68cef01](https://github.com/esmevane/rivet/commit/68cef015f1e2e780850fa9ac3290aa8165956c07))
* support pegboard container runner inside docker compose ([#2611](https://github.com/esmevane/rivet/issues/2611)) ([0b74f0d](https://github.com/esmevane/rivet/commit/0b74f0d29a91a069baf9c59963c570c40510cfef))
* switch from snake_case to camelCase in config serialization ([#2657](https://github.com/esmevane/rivet/issues/2657)) ([6383f64](https://github.com/esmevane/rivet/commit/6383f640fa72ceaae4f1ba50aa066ca0cb96b58a))
* switch logs query to use positionCaseInsensitive ([#2388](https://github.com/esmevane/rivet/issues/2388)) ([c30611d](https://github.com/esmevane/rivet/commit/c30611dbab009dd01602fdd4762df4470beba4c4))
* temporarily disable sentry ([#2406](https://github.com/esmevane/rivet/issues/2406)) ([0a94837](https://github.com/esmevane/rivet/commit/0a94837ffee0c901fd64cdafdebdacc039946b1d))
* testing ci ([13a989c](https://github.com/esmevane/rivet/commit/13a989c811a7f14dbc4c8d1f4c1a421970186971))
* tweak clickhouse options for logs ([#2387](https://github.com/esmevane/rivet/issues/2387)) ([c057c6a](https://github.com/esmevane/rivet/commit/c057c6aead68c5fc4c8e0b77f925039a00d780bd))
* tweak nav ([#2749](https://github.com/esmevane/rivet/issues/2749)) ([233cee9](https://github.com/esmevane/rivet/commit/233cee96ee420fcafca07f4330935d84441613a9))
* tweak wording for containers ([7ab4538](https://github.com/esmevane/rivet/commit/7ab45380f78d18e22d8aeae000b85da929b3fde9))
* tweak wording for studio entrypoint ([#2308](https://github.com/esmevane/rivet/issues/2308)) ([2326b4c](https://github.com/esmevane/rivet/commit/2326b4ce863ce4eca99a5e292d557955859a1695))
* udpate guard websocket tests to include message sending ([#2320](https://github.com/esmevane/rivet/issues/2320)) ([e81d2ba](https://github.com/esmevane/rivet/commit/e81d2ba6e72ed51ca8f604045d5e5163f82ffe83))
* update actor-core repo path ([b3cb221](https://github.com/esmevane/rivet/commit/b3cb221b65d9549596cc4676565226394b6cc802))
* update clickhouse user query to dynamically bind subproperties ([#2715](https://github.com/esmevane/rivet/issues/2715)) ([ce74063](https://github.com/esmevane/rivet/commit/ce74063e925b04eb2c46f8568c8721efa97d548d))
* update CTA ([#2247](https://github.com/esmevane/rivet/issues/2247)) ([460969f](https://github.com/esmevane/rivet/commit/460969fbc97771fade3b4abddccf3aa4fc6c333e))
* update cta ([#2738](https://github.com/esmevane/rivet/issues/2738)) ([443e63f](https://github.com/esmevane/rivet/commit/443e63ff5f34ec7b1a1150b54b9ead88cde7cd68))
* update default port to 6420 ([#2660](https://github.com/esmevane/rivet/issues/2660)) ([12330f4](https://github.com/esmevane/rivet/commit/12330f49fb9c89812fffb314b20859892118f461))
* update deno to fix outgoing websockets ([#2446](https://github.com/esmevane/rivet/issues/2446)) ([a050f1e](https://github.com/esmevane/rivet/commit/a050f1ee4e1b02b9caf9605d3eb37ee9e4bf5150))
* update discussion links ([ebf8d6d](https://github.com/esmevane/rivet/commit/ebf8d6d8dccbe21d521a66a0eae9923f6e6dda50))
* update docs for new cli & rivetkit ([#2683](https://github.com/esmevane/rivet/issues/2683)) ([9ef0ac4](https://github.com/esmevane/rivet/commit/9ef0ac4ea908ddb0594c492a5cd40b59a567ee7d))
* update docs for rivetkit ([#2732](https://github.com/esmevane/rivet/issues/2732)) ([f0243da](https://github.com/esmevane/rivet/commit/f0243da833e81f3257ae3944e107450a2ffabfc9))
* update download logs button to use export ([#2718](https://github.com/esmevane/rivet/issues/2718)) ([d01af0e](https://github.com/esmevane/rivet/commit/d01af0e8f96c0b8086f78cda970d6922b5ae5b15))
* update examples ([#2461](https://github.com/esmevane/rivet/issues/2461)) ([d3916f3](https://github.com/esmevane/rivet/commit/d3916f31050ab4842aa224be41bf13fc018079c6))
* update lockfile ([d8a5d93](https://github.com/esmevane/rivet/commit/d8a5d9321eb1e19a845e43a3aae78a2273cd63ce))
* update og image ([#2801](https://github.com/esmevane/rivet/issues/2801)) ([62b95a1](https://github.com/esmevane/rivet/commit/62b95a164adffb71ae399b3df5cca9dc62307cfd))
* update package name to @rivet-gg/cli ([999431d](https://github.com/esmevane/rivet/commit/999431d3634cc1163674e17ca6f08c7d7527e071))
* update pricing buttons ([#2524](https://github.com/esmevane/rivet/issues/2524)) ([fe5fde3](https://github.com/esmevane/rivet/commit/fe5fde36e9c92c6282a2ebd5cb4fc4645e19354b))
* update release please ([#2399](https://github.com/esmevane/rivet/issues/2399)) ([626d013](https://github.com/esmevane/rivet/commit/626d013b4754edf7cb80cb634b47bfce77d91e6b))
* update reqwest client ([#2249](https://github.com/esmevane/rivet/issues/2249)) ([b85c995](https://github.com/esmevane/rivet/commit/b85c9954364965776a81c0472fbd31e1d287f19d))
* update styling on sales ([#2463](https://github.com/esmevane/rivet/issues/2463)) ([7855096](https://github.com/esmevane/rivet/commit/7855096e3d4cc6f31b8925794facc49e651211ce))
* update w3c standard with recommendations ([#2269](https://github.com/esmevane/rivet/issues/2269)) ([9f92cb7](https://github.com/esmevane/rivet/commit/9f92cb7dc5de59a0b4c25e898f5bc06be56bff8d))
* update workspace ([#2505](https://github.com/esmevane/rivet/issues/2505)) ([a3cb3ec](https://github.com/esmevane/rivet/commit/a3cb3ecf120c2a08243813c0af17990fed3415c1))
* updated graphics for new landing page ([#2398](https://github.com/esmevane/rivet/issues/2398)) ([e657b90](https://github.com/esmevane/rivet/commit/e657b90e51e04a1630bb9d3ac9c2c64c905b7673))
* updated guide to print servers to json ([#2316](https://github.com/esmevane/rivet/issues/2316)) ([2e061d1](https://github.com/esmevane/rivet/commit/2e061d1601cf47bcd21c5635517856d7dfc51beb))
* updated links ([#2577](https://github.com/esmevane/rivet/issues/2577)) ([33da3fa](https://github.com/esmevane/rivet/commit/33da3fa89a7445770ba022c1202e245b69e490f0))
* updated oss friends ([#2212](https://github.com/esmevane/rivet/issues/2212)) ([c04db5c](https://github.com/esmevane/rivet/commit/c04db5c02be6d19787ee29fc57ea3068f6c779e1))
* updated scenarios Pricing ([#2457](https://github.com/esmevane/rivet/issues/2457)) ([9fe7c47](https://github.com/esmevane/rivet/commit/9fe7c47701d5863819ee201b2953648e51854007))
* updated site font ([#2204](https://github.com/esmevane/rivet/issues/2204)) ([37cce55](https://github.com/esmevane/rivet/commit/37cce55f9605638ca51e5060b2aa171b971db0b3))
* **vector:** add vector pipeline to ship clickhouse events from the edge ([#2526](https://github.com/esmevane/rivet/issues/2526)) ([ebbe9f7](https://github.com/esmevane/rivet/commit/ebbe9f7d08ad6fbc66657ee37a270bafe9674f90))
* website redesign ([#2170](https://github.com/esmevane/rivet/issues/2170)) ([fd7fdf2](https://github.com/esmevane/rivet/commit/fd7fdf2d8946999c6b953820c868c348ddf1f9ee))
* workspace typo ([15db225](https://github.com/esmevane/rivet/commit/15db225f4f6a613626feb9c11132bef9a38dbea2))
* writing rivet guard blog post ([#2509](https://github.com/esmevane/rivet/issues/2509)) ([1c35f83](https://github.com/esmevane/rivet/commit/1c35f8345d50c66c854c7509b17dd85b248ce09b))
